...
.method public static a(Landroid/content/Context;Lbywh;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 6

    .line 1
    .line 2
    .line 3
    invoke-static {p0}, Lbhcw;->h(Landroid/content/Context;)Z
    ...
    .line 8
    .line 9
    invoke-static {p1, p2}, Lbzrh;->C(Lbywh;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 28
    .line 29
    invoke-direct/range {v0 .. v5}, Lbhcv;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/content/Context;Lcom/google/common/util/concurrent/SettableFuture;Lbywh;Ljava/util/concurrent/Executor;)V
    ...
    .line 55
    .line 56
    invoke-static {v2, v0}, Lbhcw;->e(Landroid/content/Context;Landroid/content/BroadcastReceiver;)V
    ...
    .line 66
    :cond_1
    new-instance p0, Lbhcu;

    .line 67
    .line 68
    .line 69
    invoke-direct {p0, v3, v1, v2, v0}, Lbhcu;-><init>(Lcom/google/common/util/concurrent/SettableFuture;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/content/Context;Landroid/content/BroadcastReceiver;)V
...
.method public static b(Landroid/content/Context;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 9
    .line 10
    invoke-static {p0, v0, p2}, Lbhcw;->a(Landroid/content/Context;Lbywh;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static c(Landroid/content/Context;Ljava/lang/Runnable;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 9
    .line 10
    invoke-static {p0, p1, v0}, Lbhcw;->b(Landroid/content/Context;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static d(Landroid/content/Context;Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 7
    .line 8
    invoke-static {p0, p1, p2}, Lbhcw;->b(Landroid/content/Context;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public static f(Landroid/content/Context;)Z
    ...
    .line 22
    .line 23
    sget-object v3, Lbhcw;->b:Landroid/os/UserManager;
    ...
    .line 34
    .line 35
    sput-object v3, Lbhcw;->b:Landroid/os/UserManager;
    :try_end_0
    ...
    :catch_0
    :try_start_2
    sput-object v4, Lbhcw;->b:Landroid/os/UserManager;
