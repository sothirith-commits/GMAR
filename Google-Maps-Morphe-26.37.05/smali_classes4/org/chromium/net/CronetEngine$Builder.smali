...
.method private static createBuilderDelegate(Landroid/content/Context;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    .line 8
    .line 9
    invoke-direct {v0, v3, v1, v2}, Ljat;-><init>(Ljava/lang/String;I[B)V
    ...
    .line 24
    .line 25
    invoke-static {p0, v2}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProvider(Landroid/content/Context;Ljava/util/List;)Lcurj;
    ...
    .line 27
    .line 28
    iget-object v3, v2, Lcurj;->c:Lcusw;

    .line 29
    .line 30
    .line 31
    invoke-static {p0, v3}, Lcuta;->a(Landroid/content/Context;Lcusw;)Lcusz;
    ...
    .line 33
    .line 34
    new-instance v3, Lcusv;

    .line 35
    .line 36
    .line 37
    invoke-direct {v3}, Lcusv;-><init>()V
    :try_end_0
    ...
    .line 40
    .line 41
    iput-object v4, v3, Lcusv;->d:Ljava/lang/Boolean;
    ...
    .line 43
    .line 44
    iput v4, v3, Lcusv;->h:I

    .line 45
    .line 46
    iget-object v4, v2, Lcurj;->c:Lcusw;

    .line 47
    .line 48
    iput-object v4, v3, Lcusv;->c:Lcusw;
    ...
    .line 53
    .line 54
    iput v4, v3, Lcusv;->g:I

    .line 55
    .line 56
    new-instance v4, Lcusy;
    ...
    .line 62
    .line 63
    invoke-direct {v4, v5}, Lcusy;-><init>(Ljava/lang/String;)V

    .line 64
    .line 65
    iput-object v4, v3, Lcusv;->e:Lcusy;

    .line 66
    .line 67
    iget-object v2, v2, Lcurj;->a:Lorg/chromium/net/CronetProvider;
    ...
    .line 80
    .line 81
    new-instance v5, Lcusy;

    .line 82
    .line 83
    .line 84
    invoke-direct {v5, v4}, Lcusy;-><init>(Ljava/lang/String;)V

    .line 85
    .line 86
    iput-object v5, v3, Lcusv;->f:Lcusy;
    ...
    .line 103
    .line 104
    iput v0, v3, Lcusv;->b:I

    .line 105
    .line 106
    .line 107
    invoke-virtual {p0, v3}, Lcusz;->b(Lcusv;)V
    :try_end_2
...
.method static getPreferredCronetProvider(Landroid/content/Context;Ljava/util/List;)Lcurj;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 14
    .line 15
    invoke-static {p1}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProviderUsingScore(Ljava/util/List;)Lcurj;
    ...
    .line 20
    :cond_0
    invoke-static {p1}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProviderUsingVersion(Ljava/util/List;)Lcurj;
...
.method private static getPreferredCronetProviderUsingScore(Ljava/util/List;)Lcurj;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 26
    .line 27
    iget-object v1, v0, Lcurj;->a:Lorg/chromium/net/CronetProvider;
...
.method private static getPreferredCronetProviderUsingVersion(Ljava/util/List;)Lcurj;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static synthetic lambda$setConnectionMigrationOptions$2(Lorg/chromium/net/ConnectionMigrationOptions;Lorg/json/JSONObject;)V
    ...
    .line 4
    .line 5
    invoke-static {p1, v0}, Lcthq;->F(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
...
.method private maybeSetExperimentalOptions()V
    ...
    .line 38
    :try_start_0
    invoke-interface {v2, v1}, Lcurk;->applyTo(Lorg/json/JSONObject;)V
    :try_end_0
