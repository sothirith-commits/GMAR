...
.method public final c(Lbtug;)Ljava/io/File;
    .locals 1

    .line 1
    .line 2
    iget-boolean p0, p0, Lbttf;->a:Z
    ...
    .line 18
    .line 19
    invoke-interface {p0, p1}, Lbttj;->b(Landroid/net/Uri;)Ljava/io/File;
    ...
    .line 42
    .line 43
    invoke-direct {p1, p0}, Lbtsq;-><init>(Ljava/io/Closeable;)V

    .line 44
    .line 45
    :try_start_0
    iget-object p0, p1, Lbtsq;->a:Ljava/io/Closeable;

    .line 46
    .line 47
    instance-of v0, p0, Lbtsk;
    ...
    .line 53
    .line 54
    invoke-interface {p0}, Lbtsk;->c()Ljava/io/File;
    ...
    .line 57
    .line 58
    invoke-virtual {p1}, Lbtsq;->close()V
