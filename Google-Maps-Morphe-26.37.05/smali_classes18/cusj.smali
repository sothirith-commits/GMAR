...
.method public constructor <init>(Lorg/chromium/net/UrlRequest$Callback;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcusj;->a:Lorg/chromium/net/UrlRequest$Callback;
...
.method public final onCanceled(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    ...
    .line 1
    invoke-static {p2}, Lcusm;->b(Landroid/net/http/UrlResponseInfo;)Lcusm;
    ...
    .line 7
    :try_start_0
    iget-object v1, p0, Lcusj;->a:Lorg/chromium/net/UrlRequest$Callback;

    .line 8
    .line 9
    iget-object v2, p0, Lcusj;->b:Lcusl;
    ...
    .line 13
    .line 14
    iget-object p0, p0, Lcusj;->b:Lcusl;

    .line 15
    .line 16
    invoke-virtual {p0, v0, p1, p2}, Lcusl;->a(ILcusm;Lorg/chromium/net/CronetException;)V
...
.method public final onFailed(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    .line 10
    :try_start_0
    iget-object v0, p0, Lcusj;->a:Lorg/chromium/net/UrlRequest$Callback;

    .line 11
    .line 12
    iget-object v1, p0, Lcusj;->b:Lcusl;
    ...
    .line 18
    .line 19
    invoke-virtual {p0, p3, p1, p2}, Lcusl;->a(ILcusm;Lorg/chromium/net/CronetException;)V
...
.method public final onReadCompleted(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;Ljava/nio/ByteBuffer;)V
    ...
    .line 4
    invoke-direct {p1, p0, p2, p3, v0}, Lcusi;-><init>(Lcusj;Landroid/net/http/UrlResponseInfo;Ljava/lang/Object;I)V
    ...
    .line 8
    .line 9
    invoke-static {p1, p0}, Lcuul;->i(Lcust;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public final onResponseStarted(Landroid/net/http/UrlRequest;Landroid/net/http/UrlResponseInfo;)V
    ...
    .line 4
    invoke-direct {p1, p0, p2, v0}, Lcush;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
