...
.method private final a()Landroid/graphics/Canvas;
    ...
    .line 1
    .line 2
    iget-object p0, p0, Lfhw;->a:Landroid/graphics/Canvas;
    ...
    .line 9
    .line 10
    invoke-static {p0}, Lfkv;->b(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    .line 2
    .line 3
    invoke-direct {p0}, Lfhw;->a()Landroid/graphics/Canvas;
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 6
    .line 7
    invoke-static/range {p0 .. p7}, La$$ExternalSyntheticApiModelOutline4;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static/range {p0 .. p5}, La$$ExternalSyntheticApiModelOutline4;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    .line 6
    .line 7
    invoke-static/range {p0 .. p7}, La$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1, p2, p3}, La$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    .line 10
    invoke-static {p0, p1, p2, p3}, La$$ExternalSyntheticApiModelOutline6;->m(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, La$$ExternalSyntheticApiModelOutline4;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final quickReject(FFFF)Z
    ...
    .line 6
    .line 7
    invoke-static {p0, p1, p2, p3, p4}, Lajl$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    .line 12
    invoke-static {p0, p1}, Lajl$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    .line 15
    invoke-static {p0, p1}, Lajl$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
