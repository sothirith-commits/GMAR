...
# direct methods
.method public constructor <init>(Laqfl;)V
    .locals 0

    .line 1
    iput-object p1, p0, Laqfj;->a:Laqfl;
...
.method public final tP(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 36
    .line 37
    iget-object p0, p0, Laqfj;->a:Laqfl;

    .line 38
    .line 39
    invoke-virtual {p0}, Laqfl;->s()Z
    ...
    .line 53
    iput-boolean p1, p0, Laqfl;->k:Z

    .line 54
    .line 55
    iget-object p1, p0, Laqfl;->B:Lcpuk;
    ...
    .line 62
    .line 63
    iget-object p2, p0, Laqfl;->e:Lcdsu;

    .line 64
    .line 65
    invoke-interface {p1, p2}, Laqcw;->b(Lcdsu;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 72
    invoke-direct {p2, p0, p3}, Laprl;-><init>(Ljava/lang/Object;I)V
