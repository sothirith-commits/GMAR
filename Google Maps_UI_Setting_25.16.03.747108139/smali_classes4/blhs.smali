...
.method public constructor <init>(Lbssy;Lbssz;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lblhs;->c:Lbssy;

    .line 5
    .line 6
    iput-object p2, p0, Lblhs;->a:Lbssz;
...
.method public final b()Lbssy;
    ...
    .line 1
    iget-object v0, p0, Lblhs;->c:Lbssy;
...
.method public final f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lbssx;
    ...
    .line 11
    .line 12
    iget-object p2, p0, Lblhs;->c:Lbssy;

    .line 13
    .line 14
    new-instance p3, Lblhr;
    ...
    .line 24
    invoke-direct {p3, p1, v0, v1}, Lblhr;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;J)V
    ...
    .line 28
    :cond_0
    iget-object p1, p0, Lblhs;->a:Lbssz;
    ...
    .line 35
    .line 36
    invoke-direct {v2, p0, v0, v3}, Lbgic;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    .line 43
    invoke-direct {v1, v0, p1}, Lblhq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbssx;)V
...
.method public final h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbssx;
    ...
    .line 12
    .line 13
    new-instance v4, Lblhm;

    .line 14
    .line 15
    invoke-direct {v4, v0, p1, v1}, Lblhm;-><init>(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;Lbstk;)V

    .line 16
    .line 17
    .line 18
    iget-object v3, p0, Lblhs;->a:Lbssz;
    ...
    .line 28
    invoke-direct {v2, v1, p1}, Lblhq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbssx;)V
...
.method public final i(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbssx;
    ...
    .line 9
    invoke-direct {v4, v3, v0}, Lblhq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbssx;)V
    ...
    .line 18
    invoke-direct/range {v0 .. v7}, Lblhp;-><init>(Lblhs;Ljava/lang/Runnable;Lbstk;Lblhq;JLjava/util/concurrent/TimeUnit;)V

    .line 19
    .line 20
    .line 21
    iget-object p1, v1, Lblhs;->a:Lbssz;
    ...
    .line 27
    iput-object p1, v4, Lblhq;->a:Lbssx;
...
.method public final bridge synthetic schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3, p4}, Lblhs;->f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lbssx;
...
.method public final bridge synthetic schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3, p4}, Lblhs;->g(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lbssx;
...
.method public final bridge synthetic scheduleAtFixedRate(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual/range {p0 .. p6}, Lblhs;->h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbssx;
...
.method public final bridge synthetic scheduleWithFixedDelay(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual/range {p0 .. p6}, Lblhs;->i(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbssx;
