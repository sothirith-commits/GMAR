...
# direct methods
.method public constructor <init>(Ljava/lang/ref/WeakReference;Lclgs;)V
    .locals 0

    .line 1
    .line 2
    iput-object p1, p0, Lbbqu;->a:Ljava/lang/ref/WeakReference;

    .line 3
    .line 4
    iput-object p2, p0, Lbbqu;->b:Lclgs;
...
.method public final d(Lcom/google/android/gms/googlehelp/InProductHelp;)V
    ...
    .line 9
    .line 10
    const-string v4, "app.revanced.android.gms.googlehelp.HELP"
    ...
    .line 40
    :cond_0
    invoke-static {p1, v3}, Lbauo;->h(Lcom/google/android/gms/common/internal/safeparcel/SafeParcelable;Landroid/content/Intent;)V

    .line 41
    .line 42
    iget-object p1, p0, Lbbqu;->a:Ljava/lang/ref/WeakReference;
    ...
    .line 53
    :cond_1
    iget-object v4, p0, Lbbqu;->b:Lclgs;
    ...
    .line 61
    .line 62
    invoke-static {v5, v4, v0, v1, v2}, Lbalq;->T(Landroid/content/Context;Lclgs;JLcom/google/android/gms/googlehelp/GoogleHelp;)V
    ...
    .line 72
    .line 73
    invoke-static {p1}, Lbeut;->B(Landroid/app/Activity;)Ljava/lang/String;
    ...
    .line 79
    :cond_3
    invoke-static {p1, v3, v2}, Lbbqw;->b(Landroid/app/Activity;Landroid/content/Intent;Lcom/google/android/gms/googlehelp/GoogleHelp;)V
