...
.method public static n(Ljava/util/Map;Lj$/time/temporal/a;J)V
    .locals 4
...
.method public static s(Lj$/time/chrono/l;Ljava/lang/String;)Lj$/time/chrono/l;
    .locals 2
...
.method public static v(Lj$/time/chrono/ChronoLocalDate;JJJ)Lj$/time/chrono/ChronoLocalDate;
    .locals 4
    ...
    .line 34
    .line 35
    invoke-static {p5, p6, v0, v1}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    .line 50
    invoke-static {p1}, Lj$/time/DayOfWeek;->W(I)Lj$/time/DayOfWeek;
    ...
    .line 58
    invoke-interface {p0, p1}, Lj$/time/chrono/ChronoLocalDate;->j(Lj$/time/temporal/TemporalAdjuster;)Lj$/time/chrono/ChronoLocalDate;
...
# virtual methods
.method public B(Lj$/time/temporal/k;)Lj$/time/chrono/d;
    .locals 3

    .line 1
    :try_start_0
    invoke-interface {p0, p1}, Lj$/time/chrono/l;->o(Lj$/time/temporal/k;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 9
    invoke-interface {v0, v1}, Lj$/time/chrono/ChronoLocalDate;->A(Lj$/time/LocalTime;)Lj$/time/chrono/d;
...
.method public D(Ljava/util/Map;Lj$/time/format/E;)V
    .locals 5
    ...
    .line 29
    .line 30
    invoke-interface {p2, v3, v4, v2}, Lj$/time/chrono/ChronoLocalDate;->d(JLj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 38
    invoke-interface {p2, v1, v2, v0}, Lj$/time/chrono/ChronoLocalDate;->d(JLj$/time/temporal/m;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 43
    .line 44
    invoke-interface {p2, v0}, Lj$/time/temporal/k;->n(Lj$/time/temporal/m;)I
...
.method public M(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;
    .locals 19
    ...
    invoke-interface {v0, v1, v2}, Lj$/time/chrono/l;->k(J)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 3
    :cond_0
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->D(Ljava/util/Map;Lj$/time/format/E;)V

    .line 4
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->W(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 8
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->S(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 11
    invoke-interface {v0, v3}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    invoke-static {v10, v11, v6, v7}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    invoke-static {v4, v5, v6, v7}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    invoke-static {v1, v2, v6, v7}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J

    move-result-wide v1

    .line 16
    invoke-interface {v0, v3, v8, v8}, Lj$/time/chrono/l;->J(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 17
    :cond_3
    invoke-interface {v0, v4}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    invoke-virtual {v6, v12, v13, v4}, Lj$/time/temporal/o;->a(JLj$/time/temporal/m;)I

    move-result v6

    .line 18
    invoke-interface {v0, v5}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    invoke-virtual {v7, v12, v13, v5}, Lj$/time/temporal/o;->a(JLj$/time/temporal/m;)I

    move-result v5

    .line 19
    invoke-interface {v0, v9}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    invoke-virtual {v7, v12, v13, v9}, Lj$/time/temporal/o;->a(JLj$/time/temporal/m;)I

    move-result v1

    .line 20
    invoke-interface {v0, v3, v6, v8}, Lj$/time/chrono/l;->J(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v3, v7, v8, v1}, Lj$/time/chrono/ChronoLocalDate;->plus(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v1, v4}, Lj$/time/temporal/k;->n(Lj$/time/temporal/m;)I
    ...
    invoke-interface {v3, v7, v8, v5}, Lj$/time/chrono/ChronoLocalDate;->plus(JLj$/time/temporal/TemporalUnit;)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-interface {v3, v1}, Lj$/time/chrono/ChronoLocalDate;->j(Lj$/time/temporal/TemporalAdjuster;)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 44
    invoke-interface {v0, v3, v8}, Lj$/time/chrono/l;->z(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 46
    invoke-interface {v0, v3, v1}, Lj$/time/chrono/l;->z(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-static {v2, v3, v6, v7}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    .line 53
    invoke-interface {v0, v9, v8}, Lj$/time/chrono/l;->z(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    invoke-virtual {v6, v11, v12, v4}, Lj$/time/temporal/o;->a(JLj$/time/temporal/m;)I
    ...
    invoke-interface {v1, v3}, Lj$/time/temporal/k;->n(Lj$/time/temporal/m;)I
    ...
    invoke-interface {v4, v1}, Lj$/time/chrono/ChronoLocalDate;->j(Lj$/time/temporal/TemporalAdjuster;)Lj$/time/chrono/ChronoLocalDate;
...
.method public S(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;
    .locals 7
    ...
    .line 2
    .line 3
    invoke-interface {p0, v0}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    .line 39
    .line 40
    invoke-static {v3, v4, v5, v6}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    .line 56
    invoke-static {p1, p2, v5, v6}, Lj$/desugar/sun/nio/fs/g;->G(JJ)J
    ...
    .line 60
    invoke-interface {p0, v0, v2, v2}, Lj$/time/chrono/l;->J(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 78
    .line 79
    invoke-interface {p0, v1}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    .line 98
    .line 99
    invoke-interface {p0, v3}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    .line 121
    :try_start_0
    invoke-interface {p0, v0, v1, p1}, Lj$/time/chrono/l;->J(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 126
    :catch_0
    invoke-interface {p0, v0, v1, v2}, Lj$/time/chrono/l;->J(III)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 135
    .line 136
    invoke-interface {p1, p2}, Lj$/time/chrono/ChronoLocalDate;->j(Lj$/time/temporal/TemporalAdjuster;)Lj$/time/chrono/ChronoLocalDate;
...
.method public W(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/ChronoLocalDate;
    .locals 7
    ...
    .line 40
    invoke-static {v4, v5}, Lj$/desugar/sun/nio/fs/g;->v(J)I
    ...
    .line 45
    .line 46
    invoke-interface {p0, v2}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
    ...
    .line 58
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->T(I)Lj$/time/chrono/m;
    ...
    .line 63
    .line 64
    invoke-interface {p0, p2, v4}, Lj$/time/chrono/l;->a(Lj$/time/chrono/m;I)I
    ...
    .line 100
    invoke-interface {p0, p2, v5}, Lj$/time/chrono/l;->z(II)Lj$/time/chrono/ChronoLocalDate;
    ...
    .line 125
    :cond_3
    invoke-interface {p0}, Lj$/time/chrono/l;->P()Ljava/util/List;
    ...
    .line 167
    .line 168
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->N(Lj$/time/temporal/a;)Lj$/time/temporal/o;
...
.method public y(Lj$/time/temporal/k;)Lj$/time/chrono/i;
    .locals 3

    .line 1
    :try_start_0
    invoke-static {p1}, Lj$/time/ZoneId;->W(Lj$/time/temporal/k;)Lj$/time/ZoneId;
    ...
    .line 9
    invoke-interface {p0, v1, v0}, Lj$/time/chrono/l;->O(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/i;
    ...
    .line 18
    invoke-static {p0, v1}, Lj$/time/chrono/f;->W(Lj$/time/chrono/l;Lj$/time/temporal/Temporal;)Lj$/time/chrono/f;
    ...
    .line 23
    invoke-static {v0, v2, v1}, Lj$/time/chrono/k;->W(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/k;
