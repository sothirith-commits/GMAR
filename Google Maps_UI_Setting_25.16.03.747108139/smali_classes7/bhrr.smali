...
.method public constructor <init>(Lcom/google/android/libraries/geo/navcore/service/logging/transparency/storage/TripTransparencyDatabase_Impl;)V
    ...
    .line 1
    iput-object p1, p0, Lbhrr;->d:Lcom/google/android/libraries/geo/navcore/service/logging/transparency/storage/TripTransparencyDatabase_Impl;
...
.method public final a(Lgut;)V
    ...
    .line 1
    const-string v0, "CREATE TABLE IF NOT EXISTS `recent_sensor_observations_count` (`sensor_observation_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `sensor_observation_type` TEXT NOT NULL, `timestamp_ms` INTEGER NOT NULL)"
    ...
    .line 5
    .line 6
    const-string v0, "CREATE INDEX IF NOT EXISTS `index_recent_sensor_observations_count_timestamp_ms` ON `recent_sensor_observations_count` (`timestamp_ms`)"
    ...
    .line 10
    .line 11
    const-string v0, "CREATE TABLE IF NOT EXISTS `recent_signs_count` (`sign_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `sign_type` TEXT NOT NULL, `timestamp_ms` INTEGER NOT NULL)"
    ...
    .line 15
    .line 16
    const-string v0, "CREATE INDEX IF NOT EXISTS `index_recent_signs_count_timestamp_ms` ON `recent_signs_count` (`timestamp_ms`)"
    ...
    .line 20
    .line 21
    const-string v0, "CREATE TABLE IF NOT EXISTS `recorded_sensor_observation_event` (`_id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `recorded_time_millis` INTEGER NOT NULL, `observation_size_bytes` INTEGER NOT NULL)"
    ...
    .line 25
    .line 26
    const-string v0, "CREATE INDEX IF NOT EXISTS `index_recorded_sensor_observation_event_recorded_time_millis` ON `recorded_sensor_observation_event` (`recorded_time_millis`)"
    ...
    .line 35
    .line 36
    const-string v0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'298e763b959b1189be5980f6a65d39a7\')"
...
.method public final b(Lgut;)V
    ...
    .line 1
    const-string v0, "DROP TABLE IF EXISTS `recent_sensor_observations_count`"
    ...
    .line 5
    .line 6
    const-string v0, "DROP TABLE IF EXISTS `recent_signs_count`"
    ...
    .line 10
    .line 11
    const-string v0, "DROP TABLE IF EXISTS `recorded_sensor_observation_event`"
...
.method public final c(Lgut;)V
    ...
    .line 1
    iget-object v0, p0, Lbhrr;->d:Lcom/google/android/libraries/geo/navcore/service/logging/transparency/storage/TripTransparencyDatabase_Impl;
...
.method public final g(Lgut;)Lchsy;
    ...
    .line 96
    .line 97
    invoke-direct {v8, v12, v5, v9, v11}, Lgvq;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 106
    .line 107
    invoke-direct {v8, v9, v1, v4, v6}, Lgvr;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 123
    .line 124
    invoke-static {v1, v8, v2}, Lhuj;->k(Lgvr;Lgvr;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 226
    .line 227
    invoke-direct {v8, v11, v5, v3, v9}, Lgvq;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 236
    .line 237
    invoke-direct {v3, v8, v1, v4, v6}, Lgvr;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 253
    .line 254
    invoke-static {v1, v3, v2}, Lhuj;->k(Lgvr;Lgvr;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 358
    .line 359
    invoke-direct {v6, v9, v5, v2, v8}, Lgvq;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 368
    .line 369
    invoke-direct {v2, v6, v1, v3, v4}, Lgvr;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
