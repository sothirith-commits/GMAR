...
.method public final engineGetSocketFactory()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 2
    .line 3
    iget-object v1, p0, Lboie;->a:[Ljavax/net/ssl/KeyManager;

    .line 4
    .line 5
    iget-object v2, p0, Lboie;->b:[Ljavax/net/ssl/TrustManager;

    .line 6
    .line 7
    iget-object v3, p0, Lboie;->c:Ljava/security/SecureRandom;

    .line 8
    .line 9
    invoke-direct {v0, v1, v2, v3}, Lboii;-><init>([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
...
.method public final engineInit([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    ...
    .line 1
    iput-object p1, p0, Lboie;->a:[Ljavax/net/ssl/KeyManager;

    .line 2
    .line 3
    iput-object p2, p0, Lboie;->b:[Ljavax/net/ssl/TrustManager;

    .line 4
    .line 5
    iput-object p3, p0, Lboie;->c:Ljava/security/SecureRandom;
