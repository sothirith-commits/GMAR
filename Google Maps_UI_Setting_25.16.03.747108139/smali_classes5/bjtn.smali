...
.method public static a(Landroid/content/Context;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 3
    :try_start_0
    invoke-static {p1, p0}, Lbmtv;->h(Landroid/net/Uri;Landroid/content/Context;)Ljava/io/File;
    ...
    throw p0
    :try_end_0
    .catch Lbojd; {:try_start_0 .. :try_end_0} :catch_1
...
.method public static b(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p2, p0}, Lbmtv;->h(Landroid/net/Uri;Landroid/content/Context;)Ljava/io/File;
    ...
    :try_end_0
    .catch Lbojd; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/system/ErrnoException; {:try_start_0 .. :try_end_0} :catch_0
