...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0}, Lbkwa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Lbkwa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3, v0}, Lbkwa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 6
    invoke-virtual {p0}, Lbkwa;->getContext()Landroid/content/Context;

    move-result-object p1

    const v0, 0x7f0e0334

    invoke-static {p1, v0, p0}, Lbkwa;->inflate(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;

    const p1, 0x7f0b0a8b

    .line 7
    invoke-virtual {p0, p1}, Lbkwa;->findViewById(I)Landroid/view/View;

    move-result-object p1

    check-cast p1, Landroid/widget/TextView;

    iput-object p1, p0, Lbkwa;->a:Landroid/widget/TextView;

    const v0, 0x7f0b0078

    .line 8
    invoke-virtual {p0, v0}, Lbkwa;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Lcom/google/android/material/button/MaterialButton;

    iput-object v0, p0, Lbkwa;->b:Lcom/google/android/material/button/MaterialButton;
    ...
    .line 13
    invoke-static {p0, p4}, Lbpcx;->X(Landroid/view/View;I)I
    ...
    .line 19
    invoke-virtual {p0, p3}, Lbkwa;->setContentTextColor(I)V

    .line 20
    invoke-virtual {p0, p4}, Lbkwa;->setActionTextAndRippleEffectColor(I)V

    .line 21
    invoke-virtual {p0, p2}, Lbkwa;->setBackgroundColor(I)V
...
.method public setActionText(Ljava/lang/String;)V
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Lbkwa;->b:Lcom/google/android/material/button/MaterialButton;
...
.method public setContentText(Ljava/lang/CharSequence;)V
    ...
    .line 1
    iget-object v0, p0, Lbkwa;->a:Landroid/widget/TextView;
...
.method public setPresenter(Lbkvv;)V
    ...
    iget-object p1, p0, Lbkwa;->b:Lcom/google/android/material/button/MaterialButton;
...
.method public bridge synthetic setPresenter(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lbkwa;->setPresenter(Lbkvv;)V
...
.method public setStyleProvider(Lbkvy;)V
    ...
    .line 1
    iput-object p1, p0, Lbkwa;->c:Lbkvy;
    ...
    .line 7
    invoke-virtual {p0, p1}, Lbkwa;->setActionTextAndRippleEffectColor(I)V

    .line 8
    .line 9
    .line 10
    iget-object p1, p0, Lbkwa;->c:Lbkvy;
    ...
    .line 16
    invoke-virtual {p0, p1}, Lbkwa;->setBackgroundColor(I)V
    ...
    .line 25
    invoke-virtual {p0, p1}, Lbkwa;->setContentTextColor(I)V
