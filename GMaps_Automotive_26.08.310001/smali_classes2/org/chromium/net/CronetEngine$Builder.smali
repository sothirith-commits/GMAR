...
.method private static createBuilderDelegate(Landroid/content/Context;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    .line 22
    .line 23
    invoke-static {p0, v2}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProvider(Landroid/content/Context;Ljava/util/List;)Laowl;
    ...
    .line 27
    iget-object v3, v2, Laowl;->c:Laoxy;

    .line 28
    .line 29
    invoke-static {p0, v3}, Laoyc;->a(Landroid/content/Context;Laoxy;)Laoyb;
    ...
    .line 39
    .line 40
    iput-object v4, v3, Laoxx;->d:Ljava/lang/Boolean;
    ...
    .line 43
    iput v4, v3, Laoxx;->h:I

    .line 44
    .line 45
    iget-object v4, v2, Laowl;->c:Laoxy;

    .line 46
    .line 47
    iput-object v4, v3, Laoxx;->c:Laoxy;
    ...
    .line 53
    iput v4, v3, Laoxx;->g:I

    .line 54
    .line 55
    new-instance v4, Laoya;
    ...
    .line 61
    invoke-direct {v4, v5}, Laoya;-><init>(Ljava/lang/String;)V

    .line 62
    .line 63
    .line 64
    iput-object v4, v3, Laoxx;->e:Laoya;

    .line 65
    .line 66
    iget-object v2, v2, Laowl;->a:Lorg/chromium/net/CronetProvider;
    ...
    .line 81
    .line 82
    invoke-direct {v5, v4}, Laoya;-><init>(Ljava/lang/String;)V

    .line 83
    .line 84
    .line 85
    iput-object v5, v3, Laoxx;->f:Laoya;
    ...
    .line 103
    iput v0, v3, Laoxx;->b:I

    .line 104
    .line 105
    invoke-virtual {p0, v3}, Laoyb;->b(Laoxx;)V
    :try_end_2
...
.method static getPreferredCronetProvider(Landroid/content/Context;Ljava/util/List;)Laowl;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 12
    .line 13
    invoke-static {p1}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProviderUsingScore(Ljava/util/List;)Laowl;
    ...
    .line 18
    :cond_0
    invoke-static {p1}, Lorg/chromium/net/CronetEngine$Builder;->getPreferredCronetProviderUsingVersion(Ljava/util/List;)Laowl;
...
.method private static getPreferredCronetProviderUsingScore(Ljava/util/List;)Laowl;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 26
    .line 27
    iget-object v1, v0, Laowl;->a:Lorg/chromium/net/CronetProvider;
...
.method private static getPreferredCronetProviderUsingVersion(Ljava/util/List;)Laowl;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 16
    .line 17
    iget-object v1, v1, Laowl;->a:Lorg/chromium/net/CronetProvider;
...
.method static synthetic lambda$setConnectionMigrationOptions$2(Lorg/chromium/net/ConnectionMigrationOptions;Lorg/json/JSONObject;)V
    ...
    .line 2
    .line 3
    invoke-static {p1, v0}, Lajwp;->X(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
...
.method private maybeSetExperimentalOptions()V
    ...
    .line 36
    :try_start_0
    invoke-interface {v2, v1}, Laowm;->applyTo(Lorg/json/JSONObject;)V
    :try_end_0
