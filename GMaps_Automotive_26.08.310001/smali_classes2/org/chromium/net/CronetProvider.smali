...
.method private static addCronetProviderFromResourceFile(Landroid/content/Context;Laoxy;Ljava/util/Set;)Z
    .locals 7
    ...
    .line 71
    invoke-static/range {v1 .. v6}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;ILaoxy;Ljava/util/Set;Z)Z
...
.method private static addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;ILaoxy;Ljava/util/Set;Z)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 41
    .line 42
    iput-object p0, v1, Laowl;->a:Lorg/chromium/net/CronetProvider;

    .line 43
    .line 44
    iput p2, v1, Laowl;->b:I

    .line 45
    .line 46
    iput-object p3, v1, Laowl;->c:Laoxy;
...
.method static calculateHttpEngineNativeProviderScoreInternal(Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 9
    .line 10
    invoke-static {p0}, Laoyd;->b(Landroid/content/Context;)Z
    ...
    .line 14
    invoke-static {p0, v0}, Laowv;->a(Landroid/content/Context;Z)Lscy;
    ...
    .line 18
    invoke-virtual {p0}, Lscy;->bq()Ljava/util/Map;
    ...
    .line 35
    :cond_0
    invoke-virtual {p0}, Laoww;->a()Ljava/lang/String;
...
.method static getAllProviderInfos(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 7
    .line 8
    invoke-static {p0, v0, v4}, Lorg/chromium/net/CronetProvider;->addCronetProviderFromResourceFile(Landroid/content/Context;Laoxy;Ljava/util/Set;)Z

    .line 9
    .line 10
    .line 11
    sget-object v3, Laoxy;->c:Laoxy;
    ...
    .line 18
    invoke-static/range {v0 .. v5}, Lorg/chromium/net/CronetProvider;->addCronetProviderImplByClassName(Landroid/content/Context;Ljava/lang/String;ILaoxy;Ljava/util/Set;Z)Z
