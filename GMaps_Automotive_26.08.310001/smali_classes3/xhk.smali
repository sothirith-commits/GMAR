...
.method public constructor <init>(Ltfo;)V
    ...
    .line 12
    .line 13
    iput-object v0, p0, Lxhk;->b:Landroid/os/Handler;

    .line 14
    .line 15
    iput-object p1, p0, Lxhk;->a:Ltfo;
...
.method private final b(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;Z)Lacur;
    ...
    .line 27
    invoke-direct/range {v0 .. v8}, Lxhi;-><init>(Lxhk;Ljava/lang/Runnable;JJZI)V

    .line 28
    .line 29
    .line 30
    iget-object v2, p0, Lxhk;->b:Landroid/os/Handler;
    ...
    .line 34
    .line 35
    invoke-direct {p0, v0, v0}, Lxhk;->j(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/lang/Runnable;)V
...
.method private final j(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/lang/Runnable;)V
    ...
    .line 4
    invoke-direct {v0, p0, p2, v1}, Lxhg;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final d(Ljava/util/concurrent/Callable;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    .line 7
    .line 8
    invoke-direct {v1, v0, p1}, Lxhh;-><init>(Lacvd;Ljava/util/concurrent/Callable;)V

    .line 9
    .line 10
    .line 11
    iget-object p0, p0, Lxhk;->b:Landroid/os/Handler;
...
.method public final f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lacur;
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3, p4}, Lxhk;->g(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lacur;
...
.method public final g(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lacur;
    ...
    .line 12
    new-instance p4, Lxhj;

    .line 13
    .line 14
    invoke-direct {p4, p0, p1, v0, v1}, Lxhj;-><init>(Lxhk;Ljava/util/concurrent/Callable;J)V

    .line 15
    .line 16
    .line 17
    iget-object p1, p0, Lxhk;->b:Landroid/os/Handler;
    ...
    .line 21
    .line 22
    invoke-direct {p0, p4, p4}, Lxhk;->j(Lcom/google/common/util/concurrent/ListenableFuture;Ljava/lang/Runnable;)V
...
.method public final h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lacur;
    ...
    .line 7
    invoke-direct/range {v0 .. v7}, Lxhk;->b(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;Z)Lacur;
...
.method public final bridge synthetic schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3, p4}, Lxhk;->f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lacur;
