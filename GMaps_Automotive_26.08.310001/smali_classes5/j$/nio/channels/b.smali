...
.method public final synthetic lock(JJZ)Ljava/util/concurrent/Future;
    ...
    invoke-virtual/range {p0 .. p5}, Lj$/nio/channels/c;->c(JJZ)Ljava/util/concurrent/Future;
...
.method public final synthetic lock(JJZLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    ...
    .line 7
    invoke-virtual/range {p0 .. p7}, Lj$/nio/channels/c;->d(JJZLjava/lang/Object;Lj$/nio/channels/f;)V
...
.method public final synthetic read(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/nio/channels/c;->e(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
...
.method public final synthetic read(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    ...
    .line 7
    invoke-virtual/range {p0 .. p5}, Lj$/nio/channels/c;->f(Ljava/nio/ByteBuffer;JLjava/lang/Object;Lj$/nio/channels/f;)V
...
.method public final synthetic truncate(J)Ljava/nio/channels/AsynchronousFileChannel;
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Lj$/nio/channels/c;->g(J)Lj$/nio/channels/c;
...
.method public final synthetic tryLock(JJZ)Ljava/nio/channels/FileLock;
    ...
    .line 2
    .line 3
    invoke-virtual/range {p0 .. p5}, Lj$/nio/channels/c;->h(JJZ)Ljava/nio/channels/FileLock;
...
.method public final synthetic write(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/nio/channels/c;->i(Ljava/nio/ByteBuffer;J)Ljava/util/concurrent/Future;
...
.method public final synthetic write(Ljava/nio/ByteBuffer;JLjava/lang/Object;Ljava/nio/channels/CompletionHandler;)V
    ...
    .line 7
    invoke-virtual/range {p0 .. p5}, Lj$/nio/channels/c;->j(Ljava/nio/ByteBuffer;JLjava/lang/Object;Lj$/nio/channels/f;)V
