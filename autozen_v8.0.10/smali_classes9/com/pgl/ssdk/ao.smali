...
.method public run()V
    ...
    iget p0, p0, Lcom/pgl/ssdk/ao;->b:I

    invoke-direct {v1, v2, p0}, Lcom/pgl/ssdk/ap;-><init>(Landroid/content/Context;I)V

    const/4 p0, 0x1

    const/4 v2, 0x2

    invoke-virtual {v1, p0, v2, v0}, Lcom/pgl/ssdk/am;->a(II[B)V
    :try_end_0
