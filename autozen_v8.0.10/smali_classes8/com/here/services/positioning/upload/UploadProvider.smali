...
.method public cancelUpload(Lcom/here/services/HereLocationApiClient;)V
    ...
    .line 6
    .line 7
    invoke-virtual {p0}, Lcom/here/services/positioning/upload/internal/UploadClient;->cancelUpload()V
...
.method public getClient(Lcom/here/services/HereLocationApiClient;)Lcom/here/services/positioning/upload/internal/UploadClient;
    ...
    .line 1
    iget-object p0, p0, Lcom/here/services/positioning/upload/UploadProvider;->mProvider:Lcom/here/services/internal/ServiceController$Provider;
    ...
    .line 7
    check-cast p0, Lcom/here/services/positioning/upload/internal/UploadServicesController;
    ...
    .line 13
    .line 14
    const-string p1, "services.positioning.upload.UploadProvider"

    .line 15
    .line 16
    const-string v0, "getClient: controller is null, upload client instance not available"
    ...
    .line 23
    :cond_0
    invoke-virtual {p0}, Lcom/here/services/positioning/upload/internal/UploadServicesController;->getUploadClient()Lcom/here/services/positioning/upload/internal/UploadClient;
...
.method public subscribe(Lcom/here/services/HereLocationApiClient;Lcom/here/services/positioning/upload/UploadApi$Listener;)Lcom/here/posclient/Status;
    ...
    .line 10
    :cond_0
    new-instance p1, Lcom/here/services/positioning/upload/UploadProvider$ListenerBridge;

    .line 11
    .line 12
    invoke-direct {p1, p2}, Lcom/here/services/positioning/upload/UploadProvider$ListenerBridge;-><init>(Lcom/here/services/positioning/upload/UploadApi$Listener;)V

    .line 13
    .line 14
    .line 15
    invoke-virtual {p0, p1}, Lcom/here/services/positioning/upload/internal/UploadClient;->subscribe(Lcom/here/services/positioning/upload/internal/UploadListener;)Lcom/here/posclient/Status;
...
.method public upload(Lcom/here/services/HereLocationApiClient;Lcom/here/posclient/upload/UploadOptions;)Lcom/here/posclient/Status;
    ...
    .line 10
    :cond_0
    invoke-virtual {p0, p2}, Lcom/here/services/positioning/upload/internal/UploadClient;->upload(Lcom/here/posclient/upload/UploadOptions;)Lcom/here/posclient/Status;
