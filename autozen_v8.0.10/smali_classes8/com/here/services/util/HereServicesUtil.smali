...
# static fields
.field private static final HERE_NLP_PACKAGE_NAME:Ljava/lang/String; = "com.here.network.location.provider"
...
.method private static hasAccessWifiStatePermission(Landroid/content/Context;)Z
    .locals 1
    ...
    .line 2
    .line 3
    invoke-static {p0, v0}, Lcom/here/services/util/HereServicesUtil;->checkPermission(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isGpsLocationEnabled(Landroid/content/Context;)Z
    ...
    .line 20
    .line 21
    invoke-static {p0}, Lu9;->q(Landroid/location/LocationManager;)Z
    ...
    .line 43
    .line 44
    const-string v2, "isGpsLocationEnabled: %b"
...
.method private static isLocationEnabledForUser(Landroid/content/Context;I)Z
    .locals 3
    ...
    .line 23
    invoke-static {p1}, Lcom/here/odnp/util/OdnpUserHandle;->createUserHandle(I)Landroid/os/UserHandle;
    ...
    .line 56
    .line 57
    const-string v1, "isLocationEnabledForUser: userId: %d, enabled: %b"
...
.method public static isLocationProviderEnabledForUser(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    .line 6
    .line 7
    invoke-static {p0, p2}, Lcom/here/services/util/HereServicesUtil;->isLocationEnabledForUser(Landroid/content/Context;I)Z
...
.method private static isLocationProviderEnabledForUserApi17(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    .line 2
    .line 3
    const-string v1, "isLocationProviderEnabledForUser"
    ...
    .line 56
    const-string p2, "services.util.HereServicesUtil"

    .line 57
    .line 58
    const-string v0, "isLocationProviderEnabledForUserApi17: userId: %d, provider: %s, enabled: %b"

    .line 59
    .line 60
    invoke-static {p2, v0, p1}, Lcom/here/odnp/util/Log;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static isNetworkLocationEnabled(Landroid/content/Context;)Z
    ...
    .line 14
    .line 15
    invoke-static {v0}, Lu9;->q(Landroid/location/LocationManager;)Z
...
.method public static isRunningInAndroidAutomotive(Landroid/content/Context;)Z
    .locals 1
...
.method public static isRunningInNlpContext(Landroid/content/Context;)Z
    .locals 3
    ...
    .line 5
    const-string v0, "com.here.network.location.provider"
    ...
    .line 20
    .line 21
    const-string v2, "isRunningInNlpContext: %b"
...
.method public static isWifiScanEnabled(Landroid/content/Context;)Z
    ...
    .line 18
    :cond_0
    invoke-static {p0}, Lcom/here/services/util/HereServicesUtil;->hasAccessWifiStatePermission(Landroid/content/Context;)Z
