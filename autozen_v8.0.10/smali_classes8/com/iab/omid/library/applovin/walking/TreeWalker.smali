...
.method private a(Ljava/lang/String;Landroid/view/View;Lorg/json/JSONObject;)V
    ...
    iget-object p0, p0, Lcom/iab/omid/library/applovin/walking/TreeWalker;->f:Lcom/iab/omid/library/applovin/walking/a;

    invoke-virtual {p0, p1}, Lcom/iab/omid/library/applovin/walking/a;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, p0}, Lcom/iab/omid/library/applovin/utils/c;->b(Lorg/json/JSONObject;Ljava/lang/String;)V
...
.method private a(Landroid/view/View;Lorg/json/JSONObject;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/iab/omid/library/applovin/walking/a;->b(Landroid/view/View;)Lcom/iab/omid/library/applovin/walking/a$a;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p2, p0}, Lcom/iab/omid/library/applovin/utils/c;->a(Lorg/json/JSONObject;Lcom/iab/omid/library/applovin/walking/a$a;)V
...
.method private b(Landroid/view/View;Lorg/json/JSONObject;)Z
    ...
    invoke-virtual {p0}, Lcom/iab/omid/library/applovin/walking/a;->d()V
...
.method private i()V
    ...
    sget-object p0, Lcom/iab/omid/library/applovin/walking/TreeWalker;->k:Landroid/os/Handler;
    ...
    sput-object p0, Lcom/iab/omid/library/applovin/walking/TreeWalker;->k:Landroid/os/Handler;
...
.method private l()V
    ...
    invoke-virtual {p0}, Lcom/iab/omid/library/applovin/internal/k;->a()V
...
.method public a(Landroid/view/View;Lcom/iab/omid/library/applovin/processor/a;Lorg/json/JSONObject;Z)V
    ...
    :goto_3
    iget p0, v1, Lcom/iab/omid/library/applovin/walking/TreeWalker;->b:I

    add-int/2addr p0, v0

    iput p0, v1, Lcom/iab/omid/library/applovin/walking/TreeWalker;->b:I
...
.method public addTimeLogger(Lcom/iab/omid/library/applovin/walking/TreeWalker$TreeWalkerTimeLogger;)V
    ...
    iget-object p0, p0, Lcom/iab/omid/library/applovin/walking/TreeWalker;->a:Ljava/util/List;
...
.method public f()V
    ...
    iget-object p0, v3, Lcom/iab/omid/library/applovin/walking/TreeWalker;->g:Lcom/iab/omid/library/applovin/walking/b;

    iget-object v2, v3, Lcom/iab/omid/library/applovin/walking/TreeWalker;->f:Lcom/iab/omid/library/applovin/walking/a;

    invoke-virtual {v2}, Lcom/iab/omid/library/applovin/walking/a;->c()Ljava/util/HashSet;

    move-result-object v2

    invoke-virtual {p0, v6, v2, v0, v1}, Lcom/iab/omid/library/applovin/walking/b;->b(Lorg/json/JSONObject;Ljava/util/HashSet;J)V

    iget-boolean p0, v3, Lcom/iab/omid/library/applovin/walking/TreeWalker;->c:Z
    ...
    invoke-virtual {p0}, Lcom/iab/omid/library/applovin/internal/c;->a()Ljava/util/Collection;
    ...
    iget-object v1, v3, Lcom/iab/omid/library/applovin/walking/TreeWalker;->d:Ljava/util/List;

    invoke-virtual {v0, v1}, Lcom/iab/omid/library/applovin/adsession/a;->a(Ljava/util/List;)V
    ...
    :cond_2
    iget-object p0, v3, Lcom/iab/omid/library/applovin/walking/TreeWalker;->f:Lcom/iab/omid/library/applovin/walking/a;

    invoke-virtual {p0}, Lcom/iab/omid/library/applovin/walking/a;->a()V
