.class Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;
...
.method private constructor <init>(Lcom/mapbox/api/directions/v5/models/BannerText;)V
    ...
    .line 8
    iput-object v0, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->unrecognized:Ljava/util/Map;
...
.method public build()Lcom/mapbox/api/directions/v5/models/BannerText;
    ...
    .line 15
    .line 16
    new-instance v2, Lcom/mapbox/api/directions/v5/models/AutoValue_BannerText;

    .line 17
    .line 18
    iget-object v3, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->unrecognized:Ljava/util/Map;

    .line 19
    .line 20
    iget-object v4, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->text:Ljava/lang/String;

    .line 21
    .line 22
    iget-object v5, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->components:Ljava/util/List;

    .line 23
    .line 24
    iget-object v6, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->type:Ljava/lang/String;

    .line 25
    .line 26
    iget-object v7, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->modifier:Ljava/lang/String;

    .line 27
    .line 28
    iget-object v8, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->degrees:Ljava/lang/Double;

    .line 29
    .line 30
    iget-object v9, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->drivingSide:Ljava/lang/String;

    .line 31
    .line 32
    invoke-direct/range {v2 .. v9}, Lcom/mapbox/api/directions/v5/models/AutoValue_BannerText;-><init>(Ljava/util/Map;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Double;Ljava/lang/String;)V
...
.method public unrecognized(Ljava/util/Map;)Lcom/mapbox/api/directions/v5/models/BannerText$Builder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p1, p0, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->unrecognized:Ljava/util/Map;
...
.method public bridge synthetic unrecognized(Ljava/util/Map;)Lcom/mapbox/api/directions/v5/models/DirectionsJsonObject$Builder;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/mapbox/api/directions/v5/models/$AutoValue_BannerText$Builder;->unrecognized(Ljava/util/Map;)Lcom/mapbox/api/directions/v5/models/BannerText$Builder;
