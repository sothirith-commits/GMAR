...
.method public final a()Ljava/util/Set;
    ...
    const-class v0, Lciqp;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lctmz;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lctmp;
...
.method public final b(Ljava/lang/Class;)Ljava/util/Set;
    ...
    sget-object v0, Lchfm;->c:Lcvlb;

    if-nez v0, :cond_1

    const-class v3, Lchfm;
    ...
    const-string v4, "google.internal.mothership.maps.mobilemaps.offlinemap.v1.MobileMapsOfflineMapService"

    const-string v5, "GetDataView"
    ...
    const-string v5, "GetOfflineMapSize"
    ...
    sget-object p1, Lchfm;->a:Lcvlb;

    if-nez p1, :cond_7

    const-class v0, Lchfm;
    ...
    const-string v2, "google.internal.mothership.maps.mobilemaps.offlinemap.v1.MobileMapsOfflineMapService"

    const-string v3, "UpdateOfflineMaps"
