...
.method public final a()Ljava/util/Set;
    ...
    const-class v0, Lchvp;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lchzw;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lcijz;
...
.method public final b(Ljava/lang/Class;)Ljava/util/Set;
    ...
    sget-object v0, Lchdl;->a:Lcvlb;

    if-nez v0, :cond_1

    const-class v3, Lchdl;
    ...
    sget-object p1, Lchdl;->b:Lcvlb;

    if-nez p1, :cond_5

    const-class v0, Lchdl;
