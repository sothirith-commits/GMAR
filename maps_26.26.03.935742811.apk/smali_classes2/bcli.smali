...
.method public final a()Ljava/util/Set;
    ...
    const-class v0, Lctno;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lcjdk;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lctnj;
...
.method public final b(Ljava/lang/Class;)Ljava/util/Set;
    ...
    sget-object v0, Lchfr;->a:Lcvlb;

    if-nez v0, :cond_1

    const-class v3, Lchfr;
    ...
    const-string v4, "google.internal.mothership.maps.mobilemaps.personalitem.v1.MobileMapsPersonalItemService"

    const-string v5, "ListPersonalPlaces"
    ...
    const-string v5, "UpdatePersonalIntelligence"
    ...
    sget-object p1, Lchfr;->b:Lcvlb;

    if-nez p1, :cond_7

    const-class v0, Lchfr;
    ...
    const-string v2, "google.internal.mothership.maps.mobilemaps.personalitem.v1.MobileMapsPersonalItemService"

    const-string v3, "UpdatePersonalNotes"
