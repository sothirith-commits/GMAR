...
.method static constructor <clinit>()V
    ...
    invoke-static {v2, v3, v4, v0, v1}, Lcect;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;

    move-result-object v0

    sput-object v0, Lcect;->a:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Lcect;->b:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Lcect;->c:Ljava/security/spec/ECParameterSpec;
    ...
    sput-object v0, Lcect;->d:Ljava/math/BigInteger;
    ...
    sput-object v0, Lcect;->e:Ljava/math/BigInteger;
    ...
    sput-object v0, Lcect;->f:Ljava/math/BigInteger;
    ...
    sput-object v0, Lcect;->g:Ljava/math/BigInteger;

    return-void
.end method

.method static a(Lcecs;Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;
    .locals 9

    invoke-virtual {p0}, Lcecs;->a()Z
    ...
    :cond_1
    iget-object v0, p0, Lcecs;->d:Ljava/math/BigInteger;
    ...
    iget-object v2, p1, Lcecs;->d:Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lcecs;->b:Ljava/math/BigInteger;
    ...
    iget-object v5, p1, Lcecs;->b:Ljava/math/BigInteger;
    ...
    iget-object v6, p0, Lcecs;->c:Ljava/math/BigInteger;
    ...
    iget-object p1, p1, Lcecs;->c:Ljava/math/BigInteger;
    ...
    sget-object p0, Lcecs;->a:Lcecs;

    return-object p0

    :cond_2
    invoke-static {p0, p2, p3}, Lcect;->b(Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;
    ...
    sget-object p2, Lcect;->f:Ljava/math/BigInteger;
    ...
    sget-object v7, Lcect;->d:Ljava/math/BigInteger;
    ...
    new-instance p2, Lcecs;

    invoke-direct {p2, v4, p1, p0}, Lcecs;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object p2
.end method

.method static b(Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;
    .locals 8

    iget-object v0, p0, Lcecs;->c:Ljava/math/BigInteger;
    ...
    :cond_0
    iget-object v1, p0, Lcecs;->b:Ljava/math/BigInteger;
    ...
    sget-object v1, Lcect;->g:Ljava/math/BigInteger;
    ...
    invoke-direct {p2, v2, p1, p0}, Lcecs;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object p2
.end method

.method static c(Ljava/security/spec/ECPoint;Ljava/math/BigInteger;)Lcecs;
    .locals 5
    ...
    invoke-direct {v3, v1, p0, v0}, Lcecs;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static e(Ljava/math/BigInteger;Ljava/security/spec/ECParameterSpec;)Ljava/security/spec/ECPoint;
    ...
    invoke-static {p1, v0}, Lcect;->g(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECParameterSpec;)Z
    ...
    invoke-static {v1, v0}, Lcect;->f(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    invoke-static {v0}, Lcect;->d(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;

    move-result-object v2

    sget-object v3, Ljava/security/spec/ECPoint;->POINT_INFINITY:Ljava/security/spec/ECPoint;

    invoke-static {v3, v2}, Lcect;->c(Ljava/security/spec/ECPoint;Ljava/math/BigInteger;)Lcecs;

    move-result-object v3

    invoke-static {v1, v2}, Lcect;->c(Ljava/security/spec/ECPoint;Ljava/math/BigInteger;)Lcecs;
    ...
    invoke-static {v3, v1, p1, v2}, Lcect;->a(Lcecs;Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;

    move-result-object v3

    invoke-static {v1, p1, v2}, Lcect;->b(Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;
    ...
    invoke-static {v3, p1, v2}, Lcect;->b(Lcecs;Ljava/math/BigInteger;Ljava/math/BigInteger;)Lcecs;
    ...
    :cond_4
    iget-object p0, v3, Lcecs;->d:Ljava/math/BigInteger;
    ...
    iget-object v1, v3, Lcecs;->b:Ljava/math/BigInteger;
    ...
    iget-object v3, v3, Lcecs;->c:Ljava/math/BigInteger;
    ...
    :goto_3
    invoke-static {p0, v0}, Lcect;->f(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
...
.method public static f(Ljava/security/spec/ECPoint;Ljava/security/spec/EllipticCurve;)V
    ...
    invoke-static {p1}, Lcect;->d(Ljava/security/spec/EllipticCurve;)Ljava/math/BigInteger;
