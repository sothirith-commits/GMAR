...
.method private final a(Landroid/app/Notification;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {p0, v2, p1}, Lbsvw;->startForeground(ILandroid/app/Notification;)V
    :try_end_0
    ...
    iget-object p0, p0, Lbsvw;->a:Lbsuq;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    new-instance p2, Lbsuy;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iget-object v0, p0, Lbsvw;->a:Lbsuq;
    ...
    invoke-interface {p2, p0}, Lbsuz;->a(Landroid/content/Context;)Lcapl;
    ...
    invoke-direct {p2, v1}, Lbtdw;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1, v0}, Lbsvw;->a(Landroid/app/Notification;Ljava/lang/String;)V

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Lbsvw;->stopForeground(I)V

    invoke-virtual {p0, p3}, Lbsvw;->stopSelf(I)V
    ...
    iget-object p1, p0, Lbsvw;->a:Lbsuq;

    invoke-interface {p1, v0}, Lbsuq;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lfwd;->a()Landroid/app/Notification;
    ...
    invoke-virtual {p3}, Lfwd;->a()Landroid/app/Notification;

    move-result-object p3

    invoke-direct {p2, p3}, Lbtdw;-><init>(Ljava/lang/Object;)V
...
.method public final onTimeout(II)V
    ...
    new-instance v0, Lbsuy;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    invoke-interface {v0, p0}, Lbsuz;->a(Landroid/content/Context;)Lcapl;

    invoke-super {p0, p1, p2}, Lcufe;->onTimeout(II)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Lbsvw;->stopForeground(Z)V

    invoke-virtual {p0, p1}, Lbsvw;->stopSelf(I)V
