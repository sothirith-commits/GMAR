...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lazim;->an:Z

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lazim;->ap:Ljava/lang/Object;

    iput-boolean v0, p0, Lazim;->aq:Z
...
.method private final aS()V
    ...
    iget-object v0, p0, Lazim;->am:Landroid/content/ContextWrapper;
    ...
    iput-object v1, p0, Lazim;->am:Landroid/content/ContextWrapper;
...
.method public final aN()Lcugh;
    ...
    iget-object v0, p0, Lazim;->ao:Lcugh;

    if-nez v0, :cond_1

    iget-object v0, p0, Lazim;->ap:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lazim;->ao:Lcugh;
    ...
    iput-object v1, p0, Lazim;->ao:Lcugh;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lazim;->ao:Lcugh;
...
.method protected final aR()V
    ...
    invoke-virtual {p0}, Lazim;->ru()Ljava/lang/Object;
    ...
    iput-object v1, p0, Laziv;->ao:Lazrc;
    ...
    invoke-direct {v1, v2}, Lbjbr;-><init>([S)V

    new-instance v2, Lbihk;

    invoke-direct {v2, v0, v1}, Lbihk;-><init>(Lehr;Lbjbr;)V

    iput-object v2, p0, Laziv;->an:Lbihk;
...
.method public final af(Landroid/app/Activity;)V
    ...
    invoke-direct {p0}, Lazim;->aS()V

    invoke-virtual {p0}, Lazim;->aN()Lcugh;

    move-result-object p1

    invoke-virtual {p1}, Lcugh;->b()V

    invoke-virtual {p0}, Lazim;->aR()V
...
.method public final ql()Landroid/content/Context;
    ...
    iget-object p0, p0, Lazim;->am:Landroid/content/ContextWrapper;
