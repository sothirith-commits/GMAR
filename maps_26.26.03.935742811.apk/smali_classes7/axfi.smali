...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0}, Laxfi;->isInEditMode()Z

    move-result p1

    if-nez p1, :cond_1

    invoke-virtual {p0}, Laxfi;->p()Lcugz;
    ...
    :cond_0
    iget-boolean p1, p0, Laxfi;->b:Z

    if-nez p1, :cond_1

    const/4 p1, 0x1

    iput-boolean p1, p0, Laxfi;->b:Z

    invoke-virtual {p0}, Laxfi;->ru()Ljava/lang/Object;
    ...
    invoke-interface {p1, p0}, Laxfm;->r(Laxfl;)V
...
.method public final aN()Z
    ...
    iget-boolean p0, p0, Laxfi;->b:Z

    return p0
.end method

.method public final p()Lcugz;
    .locals 2

    iget-object v0, p0, Laxfi;->a:Lcugz;
    ...
    iput-object v0, p0, Laxfi;->a:Lcugz;
