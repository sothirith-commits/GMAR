...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Liod;->d:[I

    invoke-virtual {p1, p2, v1, p3, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    invoke-static {p1, v0, v0, v0}, Lfxc;->r(Landroid/content/res/TypedArray;IIZ)Z

    move-result p2

    if-eqz p2, :cond_1

    sget-object p2, Limz;->b:Limz;
    ...
    invoke-direct {p2, p3}, Limz;-><init>(I)V

    sput-object p2, Limz;->b:Limz;

    :cond_0
    sget-object p2, Limz;->b:Limz;

    invoke-virtual {p0, p2}, Landroidx/preference/Preference;->P(Lini;)V
...
.method protected final e()Landroid/os/Parcelable;
    ...
    iput-object p0, v1, Limv;->a:Ljava/lang/String;
...
.method protected final g(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Limv;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroidx/preference/DialogPreference;->g(Landroid/os/Parcelable;)V

    iget-object p1, p1, Limv;->a:Ljava/lang/String;
