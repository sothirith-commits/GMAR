...
.method public constructor <init>(Loaw;Langl;Lbgtv;Loov;)V
    ...
    iput-object p1, p0, Lanfp;->a:Loaw;
    ...
    iput-object p1, p0, Lanfp;->b:Lblvt;

    sget-object p1, Lamzx;->y:Lamzx;
    ...
    iput-object p1, p0, Lanfp;->c:Ljava/util/List;

    invoke-virtual {p3, p1}, Lbgtv;->a(Ljava/util/List;)Lbgtu;

    move-result-object p1

    iput-object p1, p0, Lanfp;->d:Lbgtu;
...
.method public l()Lblvt;
    ...
    iget-object p0, p0, Lanfp;->b:Lblvt;
...
.method public final p()Lpjw;
    ...
    iget-object v0, p0, Lanfp;->a:Loaw;
    ...
    iget-object p0, p0, Lanfp;->c:Ljava/util/List;
...
.method public q()Lbgtu;
    ...
    iget-object p0, p0, Lanfp;->d:Lbgtu;
...
.method public bridge synthetic qy()Lbgtb;
    ...
    invoke-virtual {p0}, Lanfp;->q()Lbgtu;
