...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lczul;->a:Ljava/util/Map;
    ...
    sput-object v0, Lczul;->j:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->k:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->l:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->m:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->n:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->o:[Ljava/lang/String;
    ...
    sput-object v1, Lczul;->p:[Ljava/lang/String;
    ...
    new-instance v4, Lczul;

    invoke-direct {v4, v3}, Lczul;-><init>(Ljava/lang/String;)V

    invoke-static {v4}, Lczul;->d(Lczul;)V
    ...
    :cond_0
    sget-object v0, Lczul;->k:[Ljava/lang/String;
    ...
    iput-boolean v1, v4, Lczul;->d:Z

    iput-boolean v1, v4, Lczul;->e:Z
    ...
    :cond_1
    sget-object v0, Lczul;->l:[Ljava/lang/String;
    ...
    sget-object v5, Lczul;->a:Ljava/util/Map;
    ...
    :cond_2
    sget-object v0, Lczul;->m:[Ljava/lang/String;
    ...
    :cond_3
    sget-object v0, Lczul;->n:[Ljava/lang/String;
    ...
    :cond_4
    sget-object v0, Lczul;->o:[Ljava/lang/String;
    ...
    :cond_5
    sget-object v0, Lczul;->p:[Ljava/lang/String;
...
.method private constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Lczul;->d:Z

    iput-boolean v0, p0, Lczul;->e:Z

    const/4 v0, 0x0

    iput-boolean v0, p0, Lczul;->f:Z

    iput-boolean v0, p0, Lczul;->g:Z

    iput-boolean v0, p0, Lczul;->h:Z

    iput-boolean v0, p0, Lczul;->i:Z

    iput-boolean v0, p0, Lczul;->q:Z

    iput-object p1, p0, Lczul;->b:Ljava/lang/String;

    invoke-static {p1}, Lcztd;->r(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lczul;->c:Ljava/lang/String;

    return-void
.end method

.method public static b(Ljava/lang/String;Lczuj;)Lczul;
    .locals 2

    invoke-static {p0}, Lcztd;->g(Ljava/lang/Object;)V

    sget-object v0, Lczul;->a:Ljava/util/Map;
    ...
    invoke-virtual {p1, p0}, Lczuj;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance p1, Lczul;

    invoke-direct {p1, p0}, Lczul;-><init>(Ljava/lang/String;)V

    const/4 p0, 0x0

    iput-boolean p0, p1, Lczul;->d:Z

    return-object p1

    :cond_0
    iget-boolean p1, p1, Lczuj;->c:Z
    ...
    :cond_1
    invoke-virtual {v0}, Lczul;->a()Lczul;

    move-result-object p1

    iput-object p0, p1, Lczul;->b:Ljava/lang/String;
...
.method private static d(Lczul;)V
    .locals 2

    sget-object v0, Lczul;->a:Ljava/util/Map;

    iget-object v1, p0, Lczul;->b:Ljava/lang/String;
...
# virtual methods
.method protected final a()Lczul;
    .locals 1
...
.method public final c()Z
    ...
    iget-boolean v0, p0, Lczul;->f:Z

    if-nez v0, :cond_1

    iget-boolean p0, p0, Lczul;->g:Z
...
.method protected final bridge synthetic clone()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lczul;->a()Lczul;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lczul;->b:Ljava/lang/String;
    ...
    :cond_2
    iget-boolean v1, p0, Lczul;->f:Z

    iget-boolean v3, p1, Lczul;->f:Z
    ...
    :cond_3
    iget-boolean v1, p0, Lczul;->e:Z

    iget-boolean v3, p1, Lczul;->e:Z
    ...
    :cond_4
    iget-boolean v1, p0, Lczul;->d:Z

    iget-boolean v3, p1, Lczul;->d:Z
    ...
    :cond_5
    iget-boolean v1, p0, Lczul;->h:Z

    iget-boolean v3, p1, Lczul;->h:Z
    ...
    :cond_6
    iget-boolean v1, p0, Lczul;->g:Z

    iget-boolean v3, p1, Lczul;->g:Z
    ...
    :cond_7
    iget-boolean v1, p0, Lczul;->i:Z

    iget-boolean v3, p1, Lczul;->i:Z
    ...
    :cond_8
    iget-boolean p0, p0, Lczul;->q:Z

    iget-boolean p1, p1, Lczul;->q:Z
...
.method public final hashCode()I
    ...
    iget-object v0, p0, Lczul;->b:Ljava/lang/String;
