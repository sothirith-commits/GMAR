...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkmh;->d:Landroid/graphics/Paint;
    ...
    sput-object v0, Lkmh;->a:Landroid/graphics/Paint;
    ...
    sput-object v0, Lkmh;->e:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lkmh;->c:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lkmh;->b:Landroid/graphics/Paint;
...
.method public static c(Lkho;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-static {p1}, Lkmh;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p0, p3, v0, v1}, Lkho;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lkmh;->f(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {p1, p0, p3}, Lkmh;->d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Lkmh;->d:Landroid/graphics/Paint;

    invoke-virtual {v1, p0, p2, p1}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;Landroid/graphics/Paint;)V

    invoke-static {v1}, Lkmh;->e(Landroid/graphics/Canvas;)V
    :try_end_0
