...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Ljs;->c:Landroid/widget/ProgressBar;
...
.method final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lfyu;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1, p2}, Ljs;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    invoke-interface {v0}, Lfyu;->b()V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Ljs;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Ljs;->a:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v0, p0, Ljs;->a:Landroid/graphics/Bitmap;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Ljs;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Ljs;->b:[I

    const/4 v3, 0x0

    invoke-static {v1, p1, v2, p2, v3}, Lnal;->w(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lnal;

    move-result-object p1

    invoke-virtual {p1, v3}, Lnal;->n(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v1}, Ljs;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v1}, Lnal;->n(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    if-eqz p2, :cond_3

    invoke-virtual {p0, p2, v3}, Ljs;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
