...
.field private static final c:Lbyhi;

.field private static final d:Lbyhi;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcaqn;->a:Lcaqj;

    sget-object v1, Lcanv;->a:Lcaoi;

    new-instance v2, Lcaqj;

    new-instance v3, Lcaqc;

    const/4 v4, 0x1

    invoke-direct {v3, v1, v4}, Lcaqc;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v2, v3}, Lcaqj;-><init>(Lcaqi;)V

    invoke-virtual {v2}, Lcaqj;->a()Lcaqj;

    move-result-object v1

    sput-object v1, Lcaqn;->b:Lcaqj;
    ...
    invoke-direct {v1, v4, v5}, Lcanx;-><init>(CC)V
    ...
    invoke-direct {v5, v1, v4}, Lcaog;-><init>(Lcaoi;Lcaoi;)V
    ...
    invoke-static {v3, v1}, Lcali;->e(ILjava/util/Set;)V

    const/16 v3, 0x600

    const/16 v4, 0x603

    invoke-static {v3, v4, v1}, Lcali;->f(IILjava/util/Set;)V
    ...
    invoke-static {v3, v2, v1}, Lcali;->f(IILjava/util/Set;)V

    const/16 v2, 0x202a

    const/16 v3, 0x202e

    invoke-static {v2, v3, v1}, Lcali;->f(IILjava/util/Set;)V
    ...
    invoke-static {v2, v1}, Lcali;->e(ILjava/util/Set;)V
    ...
    invoke-static {v0, v1}, Lcali;->e(ILjava/util/Set;)V
    ...
    invoke-static {v0, v3, v1}, Lcali;->f(IILjava/util/Set;)V
    ...
    invoke-static {v4, v1}, Lcali;->e(ILjava/util/Set;)V

    new-instance v4, Lbyhi;

    invoke-direct {v4, v1}, Lbyhi;-><init>(Ljava/util/Set;)V

    sput-object v4, Lcaqn;->c:Lbyhi;
    ...
    invoke-static {v2, v0, v1}, Lcali;->f(IILjava/util/Set;)V

    new-instance v0, Lbyhi;

    invoke-direct {v0, v1}, Lbyhi;-><init>(Ljava/util/Set;)V

    sput-object v0, Lcaqn;->d:Lbyhi;

    new-instance v1, Ljava/util/HashSet;

    invoke-direct {v1}, Ljava/util/HashSet;-><init>()V

    invoke-static {v0, v1}, Lcali;->E(Lbyhi;Ljava/util/Set;)V

    invoke-static {v4, v1}, Lcali;->E(Lbyhi;Ljava/util/Set;)V
...
.method public static b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, p1}, Lcaqn;->f(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v0

    sget-object v1, Lcaoh;->b:Lcaoi;

    invoke-virtual {v1, v0}, Lcaoi;->s(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p0}, Lcaoi;->c(C)Z
    ...
    invoke-virtual {v1, p1}, Lcaoi;->c(C)Z
    ...
    invoke-virtual {v1, p0}, Lcaoi;->s(Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static f(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcaqn;->a(Ljava/lang/String;I)I

    move-result v0

    invoke-static {p0, p1}, Lcaqn;->a(Ljava/lang/String;I)I
