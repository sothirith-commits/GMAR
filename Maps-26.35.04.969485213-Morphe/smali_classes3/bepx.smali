...
.field private static volatile c:Lbepx;
...
.method static constructor <clinit>()V
    ...
    .line 6
    .line 7
    sput-object v0, Lbepx;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    .line 9
    .line 10
    iput-object v0, p0, Lbepx;->a:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public static a()Lbepx;
    ...
    .line 5
    .line 6
    sget-object v0, Lbepx;->b:Ljava/lang/Object;
    ...
    .line 15
    .line 16
    invoke-direct {v1}, Lbepx;-><init>()V

    .line 17
    .line 18
    sput-object v1, Lbepx;->c:Lbepx;
...
.method public static final e(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 13
    .line 14
    invoke-static {p0, p1, p3, p4, p2}, La$$ExternalSyntheticApiModelOutline5;->m(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public final b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, Lbepx;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    .line 20
    .line 21
    invoke-static {p1, v0}, Lbepx;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 22
    .line 23
    iget-object p0, p0, Lbepx;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    .line 37
    :cond_0
    invoke-static {p1, p2}, Lbepx;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 3
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lbepx;->b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final f(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 16
    .line 17
    invoke-virtual {v1, p1}, Lbeqm;->a(Landroid/content/Context;)Lbfmz;
    ...
    .line 20
    .line 21
    invoke-virtual {v1, p5, v0}, Lbfmz;->g(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    .line 35
    .line 36
    iget-object p5, p0, Lbepx;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p2, p3, p4, p6}, Lbepx;->e(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
