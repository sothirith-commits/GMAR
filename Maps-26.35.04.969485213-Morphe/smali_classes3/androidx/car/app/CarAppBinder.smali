...
.field private volatile mCurrentSession:Lbll;
...
.field private mHostValidator:Lbsc;

.field private volatile mService:Lblf;


# direct methods
.method public constructor <init>(Lblf;Landroidx/car/app/SessionInfo;)V
    .locals 1
    ...
    .line 7
    .line 8
    iput-object p1, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;
...
.method private getCurrentLifecycle()Lgql;
    .locals 1

    .line 1
    .line 2
    iget-object p0, p0, Landroidx/car/app/CarAppBinder;->mCurrentSession:Lbll;
...
.method private getHostValidator()Lbsc;
    .locals 1

    .line 1
    .line 2
    iget-object v0, p0, Landroidx/car/app/CarAppBinder;->mHostValidator:Lbsc;
    ...
    .line 5
    .line 6
    iget-object v0, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;
    ...
    .line 14
    .line 15
    iput-object v0, p0, Landroidx/car/app/CarAppBinder;->mHostValidator:Lbsc;
...
.method private isValidCallingUid(I[Ljava/lang/String;)Z
    ...
    .line 10
    .line 11
    invoke-direct {p0}, Landroidx/car/app/CarAppBinder;->getHostValidator()Lbsc;

    .line 12
    .line 13
    new-instance p0, Lbli;

    .line 14
    .line 15
    .line 16
    invoke-direct {p0, p2, p1}, Lbli;-><init>(Ljava/lang/String;I)V
...
.method private onConfigurationChangedInternal(Lbll;Landroid/content/res/Configuration;)V
    .locals 0

    .line 1
    .line 2
    .line 3
    invoke-static {}, Lbsb;->a()V
...
.method private onHandshakeAlreadyCompletedException(Ljava/lang/String;Landroidx/car/app/IOnDoneCallback;I)Z
    ...
    .line 18
    .line 19
    invoke-static {p2, p1, p0}, Lbng;->d(Landroidx/car/app/IOnDoneCallback;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private onNewIntentInternal(Lbll;Landroid/content/Intent;)V
    .locals 0
...
.method private verifyHandshakeInfo(Lblf;ILandroidx/car/app/HandshakeInfo;)Lbli;
    .locals 1

    .line 1
    .line 2
    .line 3
    invoke-virtual {p1}, Lblf;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    .line 32
    .line 33
    invoke-static {p2, p3, p1, v0}, La;->df(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 42
    .line 43
    invoke-direct {p1, p3, p2}, Lbli;-><init>(Ljava/lang/String;I)V
...
.method public destroy()V
    ...
    .line 9
    .line 10
    iput-object v0, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;
...
.method public getAppInfo(Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 4
    .line 5
    invoke-direct {v0, p0, p1}, Lbky;-><init>(Landroidx/car/app/CarAppBinder;Landroidx/car/app/IOnDoneCallback;)V
...
.method public getAppTheme(Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 2
    .line 3
    invoke-direct {p0}, Landroidx/car/app/CarAppBinder;->getCurrentLifecycle()Lgql;
...
.method getCarAppService()Lblf;
    .locals 0

    .line 1
    .line 2
    iget-object p0, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;

    .line 3
    return-object p0
.end method

.method getCurrentSession()Lbll;
    .locals 0
...
.method public getManager(Ljava/lang/String;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 17
    .line 18
    invoke-direct {v0, p0, p1, p2}, Lblc;-><init>(Landroidx/car/app/CarAppBinder;Ljava/lang/String;Landroidx/car/app/IOnDoneCallback;)V
...
.method public synthetic lambda$getAppInfo$8$androidx-car-app-CarAppBinder(Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 15
    .line 16
    invoke-static {p1, v0, p0}, Lbng;->d(Landroidx/car/app/IOnDoneCallback;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic lambda$getManager$7$androidx-car-app-CarAppBinder(Ljava/lang/String;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 58
    .line 59
    invoke-static {p2, p0, p1}, Lbng;->d(Landroidx/car/app/IOnDoneCallback;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public synthetic lambda$onAppCreate$0$androidx-car-app-CarAppBinder(Landroidx/car/app/ICarHost;Landroid/content/res/Configuration;Landroid/content/Intent;)Ljava/lang/Object;
    ...
    .line 1
    .line 2
    iget-object p1, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;
    ...
    .line 6
    .line 7
    iget-object p1, p0, Landroidx/car/app/CarAppBinder;->mCurrentSession:Lbll;
...
.method public synthetic lambda$onAppPause$3$androidx-car-app-CarAppBinder()Ljava/lang/Object;
    ...
    .line 6
    .line 7
    sget-object p0, Lgqj;->Companion:Lgqi;
...
.method public synthetic lambda$onConfigurationChanged$6$androidx-car-app-CarAppBinder(Landroid/content/res/Configuration;)Ljava/lang/Object;
    ...
    .line 1
    .line 2
    iget-object v0, p0, Landroidx/car/app/CarAppBinder;->mCurrentSession:Lbll;
    ...
    .line 7
    .line 8
    invoke-direct {p0, v0, p1}, Landroidx/car/app/CarAppBinder;->onConfigurationChangedInternal(Lbll;Landroid/content/res/Configuration;)V
...
.method public synthetic lambda$onHandshakeCompleted$10$androidx-car-app-CarAppBinder(Landroidx/car/app/IOnDoneCallback;ILbre;)V
    .locals 2
    ...
    .line 11
    :cond_0
    iget-object v1, p0, Landroidx/car/app/CarAppBinder;->mService:Lblf;
    ...
    .line 28
    :try_start_0
    invoke-virtual {p3}, Lbre;->a()Ljava/lang/Object;
    ...
    .line 44
    :cond_2
    invoke-direct {p0, v1, p2, p3}, Landroidx/car/app/CarAppBinder;->verifyHandshakeInfo(Lblf;ILandroidx/car/app/HandshakeInfo;)Lbli;
...
.method public synthetic lambda$onNewIntent$5$androidx-car-app-CarAppBinder(Landroid/content/Intent;)Ljava/lang/Object;
    ...
    .line 7
    .line 8
    invoke-direct {p0, v0, p1}, Landroidx/car/app/CarAppBinder;->onNewIntentInternal(Lbll;Landroid/content/Intent;)V
...
.method public onAppCreate(Landroidx/car/app/ICarHost;Landroid/content/Intent;Landroid/content/res/Configuration;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 17
    .line 18
    invoke-direct {v0, p0, p1, p3, p2}, Lbla;-><init>(Landroidx/car/app/CarAppBinder;Landroidx/car/app/ICarHost;Landroid/content/res/Configuration;Landroid/content/Intent;)V

    .line 19
    .line 20
    .line 21
    invoke-static {p4, v1, v0}, Lbng;->a(Landroidx/car/app/IOnDoneCallback;Ljava/lang/String;Lbrq;)V
...
.method public onAppResume(Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 20
    .line 21
    invoke-direct {v0, p0}, Lbku;-><init>(Landroidx/car/app/CarAppBinder;)V
...
.method public onAppStop(Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 20
    .line 21
    invoke-direct {v0, p0}, Lbkz;-><init>(Landroidx/car/app/CarAppBinder;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 20
    .line 21
    invoke-direct {v0, p0, p1}, Lbkt;-><init>(Landroidx/car/app/CarAppBinder;Landroid/content/res/Configuration;)V
    ...
    .line 24
    .line 25
    invoke-static {p0, p2, v1, v0}, Lbng;->b(Lgql;Landroidx/car/app/IOnDoneCallback;Ljava/lang/String;Lbrq;)V
...
.method public onDestroyLifecycle()V
    ...
    .line 6
    .line 7
    iput-object v1, p0, Landroidx/car/app/CarAppBinder;->mCurrentSession:Lbll;
...
.method public onHandshakeCompleted(Lbre;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 8
    .line 9
    invoke-direct {v1, p0, p2, v0, p1}, Lblb;-><init>(Landroidx/car/app/CarAppBinder;Landroidx/car/app/IOnDoneCallback;ILbre;)V

    .line 10
    .line 11
    .line 12
    invoke-static {v1}, Lbsb;->b(Ljava/lang/Runnable;)V
...
.method public onNewIntent(Landroid/content/Intent;Landroidx/car/app/IOnDoneCallback;)V
    ...
    .line 20
    .line 21
    invoke-direct {v0, p0, p1}, Lbld;-><init>(Landroidx/car/app/CarAppBinder;Landroid/content/Intent;)V
