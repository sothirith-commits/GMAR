...
# direct methods
.method public constructor <init>(Lcvrx;)V
    .locals 23
    ...
    .line 13
    .line 14
    iput-object v2, v0, Lcvsk;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 26
    .line 27
    invoke-direct {v2, v4, v5, v3}, Lizz;-><init>(Ljava/lang/String;I[B)V

    .line 28
    .line 29
    :try_start_0
    iget-object v2, v1, Lcvrx;->c:Landroid/content/Context;

    .line 30
    .line 31
    iput-object v2, v0, Lcvsk;->d:Landroid/content/Context;
    ...
    .line 36
    .line 37
    iput v3, v0, Lcvsk;->a:I

    .line 38
    .line 39
    iget-object v4, v1, Lcvrx;->e:Ljava/lang/String;

    .line 40
    .line 41
    iput-object v4, v0, Lcvsk;->e:Ljava/lang/String;
    ...
    .line 55
    .line 56
    invoke-direct {v13, v4}, Lbgjy;-><init>(I)V
    ...
    .line 65
    .line 66
    iput-object v6, v0, Lcvsk;->f:Ljava/util/concurrent/ExecutorService;

    .line 67
    .line 68
    sget-object v12, Lcvsc;->d:Lcvsc;

    .line 69
    .line 70
    .line 71
    invoke-static {v2, v12}, Lcvsg;->a(Landroid/content/Context;Lcvsc;)Lcvsf;
    ...
    .line 73
    .line 74
    iput-object v7, v0, Lcvsk;->b:Lcvsf;
    :try_end_0
    ...
    .line 77
    :try_start_1
    new-instance v10, Lcvsa;

    .line 78
    .line 79
    iget-boolean v14, v1, Lcvrx;->d:Z

    .line 80
    .line 81
    iget-boolean v15, v1, Lcvrx;->g:Z

    .line 82
    .line 83
    iget-boolean v2, v1, Lcvrx;->h:Z

    .line 84
    .line 85
    iget-boolean v3, v1, Lcvrx;->i:Z

    .line 86
    .line 87
    iget-object v4, v1, Lcvrx;->j:Lcvrw;

    .line 88
    .line 89
    .line 90
    invoke-virtual {v4}, Lcvrw;->ordinal()I
    ...
    .line 123
    :goto_0
    iget-object v4, v1, Lcvrx;->k:Ljava/lang/String;

    .line 124
    .line 125
    iget-boolean v5, v1, Lcvrx;->l:Z

    .line 126
    .line 127
    .line 128
    invoke-virtual {v1}, Lcvrx;->getLogCronetInitializationRef()J
    ...
    .line 140
    .line 141
    invoke-direct/range {v13 .. v22}, Lcvsa;-><init>(ZZZZILjava/lang/String;ZJ)V
    ...
    .line 144
    .line 145
    invoke-virtual {v0}, Lcvsk;->getVersionString()Ljava/lang/String;
    ...
    .line 163
    .line 164
    new-instance v11, Lcvse;

    .line 165
    .line 166
    .line 167
    invoke-direct {v11, v0}, Lcvse;-><init>(Ljava/lang/String;)V

    .line 168
    .line 169
    .line 170
    invoke-virtual/range {v7 .. v12}, Lcvsf;->c(JLcvsa;Lcvse;Lcvsc;)V
    :try_end_1
...
.method public final a()V
    ...
    .line 1
    .line 2
    iget-object p0, p0, Lcvsk;->c:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final b(Ljava/lang/String;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;ILjava/util/Collection;ZZZIZILorg/chromium/net/RequestFinishedInfo$Listener;JLjava/lang/String;Ljava/util/ArrayList;Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)Lorg/chromium/net/ExperimentalUrlRequest;
    ...
    .line 1
    iput-wide v2, v1, Lcvsk;->g:J

    :cond_0
    iget-object v3, v1, Lcvsk;->f:Ljava/util/concurrent/ExecutorService;

    iget-object v6, v1, Lcvsk;->e:Ljava/lang/String;

    new-instance v0, Lcvsw;

    iget-wide v12, v1, Lcvsk;->g:J
    ...
    invoke-direct/range {v0 .. v17}, Lcvsw;-><init>(Lcvsk;Lorg/chromium/net/UrlRequest$Callback;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/lang/String;ZZIZIJLjava/lang/String;Ljava/util/ArrayList;Lorg/chromium/net/UploadDataProvider;Ljava/util/concurrent/Executor;)V
...
.method public final bridge synthetic newBidirectionalStreamBuilder(Ljava/lang/String;Lorg/chromium/net/BidirectionalStream$Callback;Ljava/util/concurrent/Executor;)Lorg/chromium/net/BidirectionalStream$Builder;
    ...
    .line 9
    invoke-virtual {p0, p1, p2, p3}, Lcvsk;->newBidirectionalStreamBuilder(Ljava/lang/String;Lorg/chromium/net/BidirectionalStream$Callback;Ljava/util/concurrent/Executor;)Lorg/chromium/net/ExperimentalBidirectionalStream$Builder;
...
.method public final shutdown()V
    ...
    .line 1
    .line 2
    iget-object p0, p0, Lcvsk;->f:Ljava/util/concurrent/ExecutorService;
