...
.method public static declared-synchronized checkVersion(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 4
    :try_start_0
    new-instance v1, Lcpjg;

    .line 5
    .line 6
    invoke-direct {v1, p1, p2}, Lcpjg;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 7
    .line 8
    .line 9
    invoke-static {v1}, Lcom/google/vr/dynamite/client/DynamiteClient;->getRemoteLibraryLoaderFromInfo(Lcpjg;)Lcpjf;
    ...
    .line 14
    :try_start_1
    invoke-virtual {p1, p0}, Lcpjf;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 18
    invoke-virtual {p1, p0}, Lcpjf;->b(Landroid/content/Context;)Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;
    ...
    :try_end_1
    .catch Lcpje; {:try_start_1 .. :try_end_1} :catch_0
    ...
    move-result p0
    :try_end_2
    .catch Lcpje; {:try_start_2 .. :try_end_2} :catch_0
...
.method private static declared-synchronized getRemoteLibraryLoaderFromInfo(Lcpjg;)Lcpjf;
    .locals 3
    ...
    .line 13
    .line 14
    new-instance v2, Lcpjf;

    .line 15
    .line 16
    invoke-direct {v2, p0}, Lcpjf;-><init>(Lcpjg;)V
