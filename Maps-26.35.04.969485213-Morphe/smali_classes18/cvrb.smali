...
.method public constructor <init>(Lorg/chromium/net/BidirectionalStream$Callback;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onCanceled(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;)V
    ...
    .line 1
    invoke-static {p2}, Lcvrs;->a(Landroid/net/http/UrlResponseInfo;)Lcvrs;
    ...
    .line 7
    :try_start_0
    iget-object v1, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;

    .line 8
    .line 9
    iget-object v2, p0, Lcvrb;->a:Lcvrc;
    ...
    .line 13
    .line 14
    iget-object p0, p0, Lcvrb;->a:Lcvrc;

    .line 15
    .line 16
    invoke-virtual {p0, v0, p1, p2}, Lcvrc;->a(ILcvrs;Lorg/chromium/net/CronetException;)V
...
.method public final onFailed(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HttpException;)V
    ...
    .line 5
    invoke-static {p3}, Lcvtr;->h(Ljava/lang/Exception;)Lorg/chromium/net/CronetException;
    ...
    .line 10
    :try_start_0
    iget-object v0, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;

    .line 11
    .line 12
    iget-object v1, p0, Lcvrb;->a:Lcvrc;
    ...
    .line 18
    .line 19
    invoke-virtual {p0, p3, p1, p2}, Lcvrc;->a(ILcvrs;Lorg/chromium/net/CronetException;)V
...
.method public final onReadCompleted(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Ljava/nio/ByteBuffer;Z)V
    ...
    .line 5
    iget-object p2, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onResponseTrailersReceived(Landroid/net/http/BidirectionalStream;Landroid/net/http/UrlResponseInfo;Landroid/net/http/HeaderBlock;)V
    ...
    .line 5
    new-instance p2, Lcvre;

    .line 6
    .line 7
    invoke-direct {p2, p3}, Lcvre;-><init>(Landroid/net/http/HeaderBlock;)V

    .line 8
    .line 9
    .line 10
    iget-object p3, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;
...
.method public final onStreamReady(Landroid/net/http/BidirectionalStream;)V
    ...
    .line 1
    iget-object p1, p0, Lcvrb;->b:Lorg/chromium/net/BidirectionalStream$Callback;
