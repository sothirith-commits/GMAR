...
.method public final engineGetSocketFactory()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 2
    .line 3
    iget-object v1, p0, Lbuin;->a:[Ljavax/net/ssl/KeyManager;

    .line 4
    .line 5
    iget-object v2, p0, Lbuin;->b:[Ljavax/net/ssl/TrustManager;

    .line 6
    .line 7
    iget-object p0, p0, Lbuin;->c:Ljava/security/SecureRandom;

    .line 8
    .line 9
    invoke-direct {v0, v1, v2, p0}, Lbuir;-><init>([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
...
.method public final engineInit([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    ...
    .line 1
    iput-object p1, p0, Lbuin;->a:[Ljavax/net/ssl/KeyManager;

    .line 2
    .line 3
    iput-object p2, p0, Lbuin;->b:[Ljavax/net/ssl/TrustManager;

    .line 4
    .line 5
    iput-object p3, p0, Lbuin;->c:Ljava/security/SecureRandom;
