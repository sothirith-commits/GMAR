...
.method public constructor <init>(Lbzpu;Lbzpv;)V
    ...
    .line 3
    .line 4
    iput-object p1, p0, Lbgir;->c:Lbzpu;

    .line 5
    .line 6
    iput-object p2, p0, Lbgir;->a:Lbzpv;
...
.method public final b()Lbzpu;
    ...
    .line 1
    iget-object p0, p0, Lbgir;->c:Lbzpu;
...
.method public final f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lbzpt;
    ...
    .line 26
    invoke-direct/range {v0 .. v5}, Lbqdw;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;JI[B)V
    ...
    .line 30
    :cond_0
    iget-object p1, p0, Lbgir;->a:Lbzpv;
    ...
    .line 37
    invoke-direct {v2, p0, v0, v3}, Lbfqc;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    .line 44
    invoke-direct {v1, v0, p0}, Lbgiq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbzpt;)V
...
.method public final h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbzpt;
    ...
    .line 15
    .line 16
    invoke-direct {p1, v0, v3, v1}, Lbgin;-><init>(Ljava/util/concurrent/Executor;Ljava/lang/Runnable;Lcom/google/common/util/concurrent/SettableFuture;)V

    .line 17
    .line 18
    .line 19
    iget-object p0, p0, Lbgir;->a:Lbzpv;
    ...
    .line 25
    invoke-direct {v2, v1, p0}, Lbgiq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbzpt;)V
...
.method public final i(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbzpt;
    ...
    .line 9
    invoke-direct {v4, v3, v0}, Lbgiq;-><init>(Lcom/google/common/util/concurrent/ListenableFuture;Lbzpt;)V
    ...
    .line 18
    invoke-direct/range {v0 .. v7}, Lbgip;-><init>(Lbgir;Ljava/lang/Runnable;Lcom/google/common/util/concurrent/SettableFuture;Lbgiq;JLjava/util/concurrent/TimeUnit;)V

    .line 19
    .line 20
    .line 21
    iget-object p0, v1, Lbgir;->a:Lbzpv;
    ...
    .line 27
    iput-object p0, v4, Lbgiq;->a:Lbzpt;
...
.method public final bridge synthetic schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3, p4}, Lbgir;->f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lbzpt;
...
.method public final bridge synthetic schedule(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 6
    invoke-virtual {p0, p1, p2, p3, p4}, Lbgir;->g(Ljava/util/concurrent/Callable;JLjava/util/concurrent/TimeUnit;)Lbzpt;
...
.method public final bridge synthetic scheduleAtFixedRate(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual/range {p0 .. p6}, Lbgir;->h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbzpt;
...
.method public final bridge synthetic scheduleWithFixedDelay(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 1
    invoke-virtual/range {p0 .. p6}, Lbgir;->i(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lbzpt;
