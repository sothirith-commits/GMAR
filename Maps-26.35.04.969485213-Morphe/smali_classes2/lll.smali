...
.method static constructor <clinit>()V
    ...
    .line 3
    .line 4
    sput-object v0, Llll;->h:Landroid/graphics/Typeface;
    ...
    .line 30
    .line 31
    sput-object v4, Llll;->a:Landroid/content/res/ColorStateList;
    ...
    .line 38
    .line 39
    sput-object v0, Llll;->c:Landroid/graphics/Typeface;
    ...
    .line 47
    .line 48
    sput-object v0, Llll;->d:Landroid/graphics/Path;
    ...
    .line 54
    .line 55
    sput-object v0, Llll;->e:Landroid/graphics/Rect;
    ...
    .line 61
    .line 62
    sput-object v0, Llll;->f:Landroid/graphics/RectF;
...
.method public static e(Ljava/lang/CharSequence;IILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 234
    :goto_9
    invoke-static {v0}, Llll;->k(Landroid/text/Spanned;)Z
...
.method public static g(Ljava/lang/CharSequence;)Z
    ...
    .line 16
    .line 17
    invoke-interface {v2, p0, v1, v0}, Lgbr;->a(Ljava/lang/CharSequence;II)Z
...
.method public static h(Llnk;)Lgbr;
    .locals 1
...
.method public static i(Ljava/lang/CharSequence;Ljava/lang/CharSequence;F)Ljava/lang/CharSequence;
    ...
    .line 27
    .line 28
    invoke-static {p0}, Llll;->k(Landroid/text/Spanned;)Z
    ...
    .line 72
    .line 73
    invoke-direct {v6, v0, v7, v8}, Lbhf;-><init>(Ljava/lang/Object;I[B)V
...
.method public static j(Lkza;ILandroid/text/TextUtils$TruncateAt;ZIFFFILjava/lang/CharSequence;Landroid/content/res/ColorStateList;IIFILandroid/graphics/Typeface;ILlnk;FIZ)Landroid/text/Layout;
    .locals 18
    ...
    .line 1
    new-instance v12, Lkyj;

    invoke-direct {v12}, Lkyj;-><init>()V

    const/4 v11, 0x0

    iput-boolean v11, v12, Lkyj;->g:Z
    ...
    .line 6
    :goto_0
    iget-object v11, v12, Lkyj;->e:Lkyi;

    iget-object v15, v11, Lkyi;->a:Landroid/text/TextPaint;
    ...
    .line 8
    invoke-virtual {v11}, Lkyi;->a()V

    iget-object v14, v11, Lkyi;->a:Landroid/text/TextPaint;

    .line 9
    iput v13, v14, Landroid/text/TextPaint;->density:F

    iput-object v15, v12, Lkyj;->f:Landroid/text/Layout;

    :cond_3
    iget-object v13, v11, Lkyi;->n:Landroid/text/TextUtils$TruncateAt;

    if-eq v13, v0, :cond_4

    iput-object v0, v11, Lkyi;->n:Landroid/text/TextUtils$TruncateAt;

    iput-object v15, v12, Lkyj;->f:Landroid/text/Layout;

    :cond_4
    iget v0, v11, Lkyi;->o:I

    if-eq v0, v2, :cond_5

    iput v2, v11, Lkyi;->o:I
    ...
    iput v3, v11, Lkyi;->d:F

    iput v4, v11, Lkyi;->b:F

    iput v5, v11, Lkyi;->c:F

    iput v6, v11, Lkyi;->e:I

    iget-object v0, v11, Lkyi;->a:Landroid/text/TextPaint;
    ...
    iget-object v0, v11, Lkyi;->h:Ljava/lang/CharSequence;
    ...
    .line 16
    iget-object v0, v12, Lkyj;->e:Lkyi;

    iget-object v0, v0, Lkyi;->h:Ljava/lang/CharSequence;
    ...
    iput-object v7, v0, Lkyi;->h:Ljava/lang/CharSequence;
    ...
    iget-object v2, v12, Lkyj;->e:Lkyi;
    ...
    :cond_b
    iget-boolean v0, v2, Lkyi;->l:Z

    if-eq v0, v1, :cond_c

    iput-boolean v1, v2, Lkyi;->l:Z
    ...
    :cond_e
    iget-object v0, v2, Lkyi;->a:Landroid/text/TextPaint;
    ...
    iget-boolean v0, v2, Lkyi;->m:Z

    move/from16 v1, p20

    if-eq v0, v1, :cond_11

    iput-boolean v1, v2, Lkyi;->m:Z
    ...
    .line 22
    invoke-virtual {v12, v9}, Lkyj;->b(I)V
    ...
    .line 23
    iget-object v1, v1, Lkza;->l:Ltnx;

    const/high16 v3, 0x41600000    # 14.0f

    .line 24
    invoke-virtual {v1, v3}, Ltnx;->A(F)I

    move-result v1

    .line 25
    invoke-virtual {v12, v1}, Lkyj;->b(I)V

    .line 26
    :goto_3
    iget-object v1, v2, Lkyi;->a:Landroid/text/TextPaint;
    ...
    iput v1, v12, Lkyj;->b:I

    const v3, 0x7fffffff

    iput v3, v12, Lkyj;->c:I

    iput v1, v12, Lkyj;->d:I
    ...
    iput-object v1, v2, Lkyi;->i:Landroid/content/res/ColorStateList;

    iget-object v1, v2, Lkyi;->a:Landroid/text/TextPaint;

    iget-object v3, v2, Lkyi;->i:Landroid/content/res/ColorStateList;
    ...
    sget-object v1, Llll;->h:Landroid/graphics/Typeface;
    ...
    .line 33
    invoke-virtual {v12, v11}, Lkyj;->c(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {v12, v1}, Lkyj;->c(Landroid/graphics/Typeface;)V

    .line 35
    :goto_5
    invoke-static/range {p17 .. p17}, Llll;->h(Llnk;)Lgbr;

    move-result-object v1

    iget-object v3, v2, Lkyi;->q:Lgbr;

    if-eq v3, v1, :cond_16

    iput-object v1, v2, Lkyi;->q:Lgbr;
    ...
    invoke-interface {v1, v7, v3, v0}, Lgbr;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-interface {v1, v7, v3, v4}, Lgbr;->a(Ljava/lang/CharSequence;II)Z
    ...
    .line 42
    :goto_8
    iget-object v1, v2, Lkyi;->p:Landroid/text/Layout$Alignment;

    if-eq v1, v0, :cond_1d

    iput-object v0, v2, Lkyi;->p:Landroid/text/Layout$Alignment;
    ...
    :cond_1d
    :try_start_1
    invoke-virtual {v12}, Lkyj;->a()Landroid/text/Layout;
