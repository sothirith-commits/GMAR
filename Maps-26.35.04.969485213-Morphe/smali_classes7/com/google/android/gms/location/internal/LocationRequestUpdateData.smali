...
.field private final e:Lbfbb;

.field private final f:Lbfay;

.field private final g:Lbfbl;
...
.method public constructor <init>(ILcom/google/android/gms/location/internal/LocationRequestInternal;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/PendingIntent;Landroid/os/IBinder;Ljava/lang/String;)V
    ...
    .line 25
    :cond_0
    new-instance p2, Lbfaz;

    .line 26
    .line 27
    .line 28
    invoke-direct {p2, p3}, Lbfaz;-><init>(Landroid/os/IBinder;)V
    ...
    .line 32
    :goto_0
    iput-object p2, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lbfbb;
    ...
    .line 51
    :cond_2
    new-instance p2, Lbfaw;

    .line 52
    .line 53
    .line 54
    invoke-direct {p2, p4}, Lbfaw;-><init>(Landroid/os/IBinder;)V
    ...
    .line 58
    :goto_1
    iput-object p2, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lbfay;
    ...
    .line 77
    .line 78
    invoke-direct {p1, p6}, Lbfbj;-><init>(Landroid/os/IBinder;)V

    .line 79
    .line 80
    :cond_5
    :goto_2
    iput-object p1, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->g:Lbfbl;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 19
    .line 20
    iget-object v0, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->e:Lbfbb;
    ...
    .line 28
    :cond_0
    invoke-interface {v0}, Lbfbb;->asBinder()Landroid/os/IBinder;
    ...
    .line 32
    .line 33
    invoke-static {p1, v3, v0}, Lbeib;->C(Landroid/os/Parcel;ILandroid/os/IBinder;)V
    ...
    .line 40
    .line 41
    iget-object p2, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->f:Lbfay;
    ...
    .line 48
    :cond_1
    invoke-interface {p2}, Lbfay;->asBinder()Landroid/os/IBinder;
    ...
    .line 52
    .line 53
    invoke-static {p1, v0, p2}, Lbeib;->C(Landroid/os/Parcel;ILandroid/os/IBinder;)V

    .line 54
    .line 55
    iget-object p2, p0, Lcom/google/android/gms/location/internal/LocationRequestUpdateData;->g:Lbfbl;
    ...
    .line 61
    :cond_2
    invoke-interface {p2}, Lbfbl;->asBinder()Landroid/os/IBinder;
    ...
    .line 65
    .line 66
    invoke-static {p1, p2, v2}, Lbeib;->C(Landroid/os/Parcel;ILandroid/os/IBinder;)V
