...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ljzt;->c:Ljava/util/Set;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Ljzt;->a:Ljava/util/Set;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Ljzt;->b:Ljava/util/Set;
...
.method final a(Z)V
    ...
    invoke-static {v1, p0, p1}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/animation/Animator$AnimatorListener;Landroid/animation/Animator;Z)V
...
.method public final addListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    iget-object p0, p0, Ljzt;->a:Ljava/util/Set;
...
.method public final addPauseListener(Landroid/animation/Animator$AnimatorPauseListener;)V
    ...
    iget-object p0, p0, Ljzt;->b:Ljava/util/Set;
...
.method public final addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    ...
    iget-object p0, p0, Ljzt;->c:Ljava/util/Set;
...
.method public final b()V
    ...
    iget-object v0, p0, Ljzt;->c:Ljava/util/Set;
...
.method public final bridge synthetic setDuration(J)Landroid/animation/Animator;
    ...
    invoke-virtual {p0, p1, p2}, Ljzt;->setDuration(J)Landroid/animation/ValueAnimator;
