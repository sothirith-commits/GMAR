...
.field final synthetic c:Lbola;


# direct methods
.method public constructor <init>(Lbnxa;FLbola;)V
    .locals 0

    iput-object p1, p0, Lbojl;->a:Lbnxa;

    iput p2, p0, Lbojl;->b:F

    iput-object p3, p0, Lbojl;->c:Lbola;
...
.method public final a(Lbojc;)V
    ...
    iget-object v0, p0, Lbojl;->a:Lbnxa;

    invoke-virtual {v1, v0}, Lbokw;->e(Lbnxa;)V

    iget v0, p0, Lbojl;->b:F

    iput v0, v1, Lbokw;->e:F

    iget-object v0, p0, Lbojl;->c:Lbola;
...
.method public final b(Lbjld;)Lbofh;
    ...
    iget-object p1, p0, Lbojl;->a:Lbnxa;

    invoke-virtual {v0, p1}, Lbofg;->l(Lbnxa;)V

    iget p1, p0, Lbojl;->b:F

    invoke-virtual {v0, p1}, Lbofg;->q(F)V

    iget-object p0, p0, Lbojl;->c:Lbola;

    iget p1, p0, Lbola;->b:F

    iget p0, p0, Lbola;->c:F

    invoke-static {p1, p0}, Lbofj;->b(FF)Lbofj;
