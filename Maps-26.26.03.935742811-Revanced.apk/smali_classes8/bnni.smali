...
.method public constructor <init>(Lcwfc;)V
    ...
    iput-object v0, p0, Lbnni;->b:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lbnni;->c:Ljava/lang/Object;

    sget-object v0, Lbnjo;->a:[B

    iput-object v0, p0, Lbnni;->a:[B

    new-instance v0, Landroid/util/LongSparseArray;

    invoke-direct {v0}, Landroid/util/LongSparseArray;-><init>()V

    iput-object v0, p0, Lbnni;->d:Landroid/util/LongSparseArray;

    new-instance v0, Lbmjl;

    const/4 v1, 0x2

    invoke-direct {v0, v1}, Lbmjl;-><init>(I)V

    invoke-virtual {p1, v0}, Lcwfc;->q(Lcwgn;)Lcwfc;
    ...
    iput-object p1, p0, Lbnni;->e:Lcwfc;
...
.method public final subscribe(Lcom/google/android/libraries/elements/interfaces/ClientDataObserver;)J
    ...
    :cond_0
    iget-object v0, p0, Lbnni;->b:Ljava/util/concurrent/atomic/AtomicLong;

    iget-object v1, p0, Lbnni;->c:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lbnni;->d:Landroid/util/LongSparseArray;

    iget-object p0, p0, Lbnni;->e:Lcwfc;
...
.method public final unsubscribe(J)V
    ...
    iget-object v0, p0, Lbnni;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object p0, p0, Lbnni;->d:Landroid/util/LongSparseArray;
