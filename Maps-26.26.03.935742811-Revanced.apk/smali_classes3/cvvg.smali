...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcvvg;->c:Ljava/lang/RuntimeException;

    return-void
.end method

.method public constructor <init>(Lcvvh;Lcvke;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentMap;)V
    .locals 2
    ...
    iput-object p1, p0, Lcvvg;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/lang/ref/SoftReference;

    sget-boolean v0, Lcvvg;->b:Z
    ...
    :cond_0
    sget-object v0, Lcvvg;->c:Ljava/lang/RuntimeException;

    :goto_0
    invoke-direct {p1, v0}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lcvvg;->g:Ljava/lang/ref/Reference;

    invoke-virtual {p2}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcvvg;->f:Ljava/lang/String;

    iput-object p3, p0, Lcvvg;->d:Ljava/lang/ref/ReferenceQueue;

    iput-object p4, p0, Lcvvg;->e:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {p4, p0, p0}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p3}, Lcvvg;->b(Ljava/lang/ref/ReferenceQueue;)V
...
.method static b(Ljava/lang/ref/ReferenceQueue;)V
    ...
    iget-object v1, v0, Lcvvg;->g:Ljava/lang/ref/Reference;
    ...
    iget-object v2, v0, Lcvvg;->h:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicBoolean;->get()Z

    move-result v2

    invoke-direct {v0}, Lcvvg;->c()V

    if-nez v2, :cond_0

    sget-object v2, Ljava/util/logging/Level;->SEVERE:Ljava/util/logging/Level;

    sget-object v3, Lcvvh;->b:Ljava/util/logging/Logger;
    ...
    iget-object v0, v0, Lcvvg;->f:Ljava/lang/String;
...
.method private final c()V
    ...
    iget-object v0, p0, Lcvvg;->e:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {v0, p0}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p0, p0, Lcvvg;->g:Ljava/lang/ref/Reference;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcvvg;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0}, Lcvvg;->clear()V
...
.method public final clear()V
    ...
    invoke-direct {p0}, Lcvvg;->c()V

    iget-object p0, p0, Lcvvg;->d:Ljava/lang/ref/ReferenceQueue;

    invoke-static {p0}, Lcvvg;->b(Ljava/lang/ref/ReferenceQueue;)V
