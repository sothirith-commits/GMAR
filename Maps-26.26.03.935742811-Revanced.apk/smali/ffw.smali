...
.method private final a()Landroid/graphics/Canvas;
    ...
    iget-object p0, p0, Lffw;->a:Landroid/graphics/Canvas;
    ...
    invoke-static {p0}, Lfiv;->b(Ljava/lang/String;)Ljava/lang/Void;
...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    invoke-direct {p0}, Lffw;->a()Landroid/graphics/Canvas;

    move-result-object p0

    invoke-static {p0, p1}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, p1}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Leg$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2}, Leg$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-static {p0, p1, p2}, Leg$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-static {p0, p1, p2, p3}, Leg$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p7}, La$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p5}, La$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p7}, La$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lecn$$ExternalSyntheticApiModelOutline9;->m(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, p3}, Lecn$$ExternalSyntheticApiModelOutline9;->m(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    invoke-static {p0, p1}, La$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    invoke-static/range {p0 .. p9}, Leg$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lajb$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-static {p0, p1}, Lajb$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p0, p1}, Lajb$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
