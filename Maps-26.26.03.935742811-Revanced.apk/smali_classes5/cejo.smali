...
.method public constructor <init>(Lcom/google/fcp/client/privatelogger/impl/PrivateLoggerDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcejo;->d:Lcom/google/fcp/client/privatelogger/impl/PrivateLoggerDatabase_Impl;
...
.method public final a(Liwl;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `DbLogEntry` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `value` BLOB, `timestampMillis` INTEGER NOT NULL, `timestamp` TEXT)"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'0b210131e81e63d37d3eea4bfca483df\')"
...
.method public final b(Liwl;)V
    ...
    const-string p0, "DROP TABLE IF EXISTS `DbLogEntry`"
...
.method public final c(Liwl;)V
    ...
    iget-object p0, p0, Lcejo;->d:Lcom/google/fcp/client/privatelogger/impl/PrivateLoggerDatabase_Impl;
...
.method public final g(Liwl;)Lcqnj;
    ...
    const-string v2, "DbLogEntry(com.google.fcp.client.privatelogger.impl.DbLogEntry).\n Expected:\n"
