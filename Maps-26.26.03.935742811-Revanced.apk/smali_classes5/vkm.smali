...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lvkm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lvkm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object p2, Lvkl;->a:Lvkl;

    iput-object p2, p0, Lvkm;->d:Lvkl;

    new-instance p2, Lvkn;

    invoke-direct {p2, p1}, Lvkn;-><init>(Landroid/content/Context;)V

    iput-object p2, p0, Lvkm;->b:Lvkn;

    new-instance p3, Lvju;

    invoke-direct {p3, p1}, Lvju;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lvkm;->c:Lvju;

    invoke-virtual {p0, p2}, Lvkm;->addView(Landroid/view/View;)V

    invoke-virtual {p0, p3}, Lvkm;->addView(Landroid/view/View;)V
    ...
    invoke-virtual {p3}, Lvju;->getPaddingTop()I
    ...
    invoke-virtual {p3}, Lvju;->getPaddingBottom()I

    move-result p2

    invoke-virtual {p3, v1, v2, p1, p2}, Lvju;->setPadding(IIII)V
...
.method public static a(I)Lblsp;
    ...
    sget-object v0, Lvkk;->h:Lvkk;

    invoke-static {p0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p0

    sget-object v1, Lvkm;->a:Lblqb;
...
.method final d()V
    ...
    iget-object v0, p0, Lvkm;->b:Lvkn;

    invoke-virtual {v0}, Lvkn;->c()Z

    move-result v1

    iget-object v2, p0, Lvkm;->c:Lvju;
    ...
    invoke-virtual {v5, p0}, Lvkm;->post(Ljava/lang/Runnable;)Z
    ...
    iget-object p0, v5, Lvkm;->d:Lvkl;

    sget-object v0, Lvkl;->b:Lvkl;
...
.method public final k(Lblxf;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lvkm;->getContext()Landroid/content/Context;
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, p0, Lvkm;->d:Lvkl;

    invoke-virtual {v0}, Lvkl;->ordinal()I
    ...
    :cond_0
    invoke-direct {p0, v1}, Lvkm;->o(I)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, v2}, Lvkm;->o(I)V
    ...
    :cond_3
    invoke-virtual {p0}, Lvkm;->getPaddingTop()I

    move-result v4

    invoke-virtual {p0}, Lvkm;->getPaddingBottom()I

    move-result v5

    add-int/2addr v4, v5

    invoke-virtual {p0}, Lvkm;->getPaddingLeft()I

    move-result v5

    invoke-virtual {p0}, Lvkm;->getPaddingRight()I

    move-result v6

    add-int/2addr v5, v6

    invoke-static {p1, v5}, Lvkm;->n(II)I

    move-result v5

    invoke-static {p2, v4}, Lvkm;->n(II)I
