...
.method public constructor <init>(Lbnpl;Lalpy;)V
    ...
    sget-object v0, Lcljq;->b:Lcqro;

    sget-object v1, Lcljr;->b:Lcqro;

    invoke-direct {p0, v0, v1}, Lbacb;-><init>(Lcqra;Lcqra;)V

    iput-object p1, p0, Lamjp;->a:Lbnpl;

    iput-object p2, p0, Lamjp;->b:Lalpy;
...
.method public final synthetic a(Lcom/google/protobuf/MessageLite;Lbaby;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    iget-object p1, p0, Lamjp;->b:Lalpy;
    ...
    const-string p1, "Account name is missing. Unable to get keychain domain status."
    ...
    :cond_0
    iget-object p0, p0, Lamjp;->a:Lbnpl;

    invoke-interface {p0, p1}, Lbnpl;->c(Ljava/lang/String;)Lcom/google/common/util/concurrent/ListenableFuture;
