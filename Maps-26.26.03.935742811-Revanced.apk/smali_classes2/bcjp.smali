...
.method public final a()Ljava/util/Set;
    ...
    const-class v0, Lctdw;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lctey;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lcjid;
...
.method public final b(Ljava/lang/Class;)Ljava/util/Set;
    ...
    sget-object v0, Lchhi;->a:Lcvlb;

    if-nez v0, :cond_1

    const-class v3, Lchhi;
    ...
    const-string v4, "google.internal.mothership.maps.mobilemaps.v1.MobileMapsService"
    ...
    const-string v5, "ClientParameters"
    ...
    sget-object p1, Lchhi;->c:Lcvlb;

    if-nez p1, :cond_7

    const-class v0, Lchhi;
    ...
    const-string v2, "google.internal.mothership.maps.mobilemaps.v1.MobileMapsService"
