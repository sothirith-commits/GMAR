...
.method protected final synthetic b(Livt;Ljava/lang/Object;)V
    .locals 4
    ...
    invoke-interface {p1, v2}, Livt;->i(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p1, v2, p0}, Livt;->j(ILjava/lang/String;)V
    ...
    iget-wide v2, p2, Lbvca;->j:J

    invoke-interface {p1, p0, v2, v3}, Livt;->h(IJ)V

    const/16 p0, 0xc

    iget-wide v2, p2, Lbvca;->k:J
