...
.method public final a()Ljava/util/Set;
    ...
    const-class v0, Lciln;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lciym;

    invoke-interface {p0, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    const-class v0, Lcjhi;
...
.method public final b(Ljava/lang/Class;)Ljava/util/Set;
    ...
    sget-object v0, Lchfa;->b:Lcvlb;

    if-nez v0, :cond_1

    const-class v3, Lchfa;
    ...
    const-string v4, "google.internal.mothership.maps.mobilemaps.merchantproducts.v1.MobileMapsMerchantProductsService"

    const-string v5, "ListMerchantProductAnswers"
    ...
    const-string v5, "ReportMerchantProductQuestion"
    ...
    sget-object p1, Lchfa;->c:Lcvlb;

    if-nez p1, :cond_7

    const-class v0, Lchfa;
    ...
    const-string v2, "google.internal.mothership.maps.mobilemaps.merchantproducts.v1.MobileMapsMerchantProductsService"

    const-string v3, "UpdateMerchantProductAnswer"
