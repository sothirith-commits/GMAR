...
# direct methods
.method public constructor <init>(Lj$/util/stream/s5;IJJ)V
    .locals 0

    iput-wide p3, p0, Lj$/util/stream/b6;->m:J

    iput-wide p5, p0, Lj$/util/stream/b6;->n:J
...
.method public final u(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/p2;
    ...
    iget-wide v8, p0, Lj$/util/stream/b6;->m:J

    iget-wide v10, p0, Lj$/util/stream/b6;->n:J
    ...
    invoke-static {p1, p0, v5, p3}, Lj$/util/stream/i4;->y(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/p2;
    ...
    iget-wide p1, p0, Lj$/util/stream/b6;->m:J

    cmp-long v4, p1, v0

    iget-wide v8, p0, Lj$/util/stream/b6;->n:J
    ...
    invoke-static {p0, v6, v5, p3}, Lj$/util/stream/i4;->y(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/p2;
    ...
    iget-wide v5, p0, Lj$/util/stream/b6;->m:J

    move-object v3, v7

    iget-wide v7, p0, Lj$/util/stream/b6;->n:J
...
.method public final v(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v6, p0, Lj$/util/stream/b6;->n:J
    ...
    iget-wide v10, p0, Lj$/util/stream/b6;->m:J
    ...
    iget-wide v0, p0, Lj$/util/stream/b6;->m:J
    ...
    new-instance v4, Lj$/util/stream/g1;

    const/16 v2, 0x14

    invoke-direct {v4, v2}, Lj$/util/stream/g1;-><init>(I)V
...
.method public final x(ILj$/util/stream/z5;)Lj$/util/stream/z5;
    ...
    iget-wide v2, p0, Lj$/util/stream/b6;->m:J

    iget-wide v4, p0, Lj$/util/stream/b6;->n:J

    move-object v1, p2

    invoke-direct/range {v0 .. v5}, Lj$/util/stream/a6;-><init>(Lj$/util/stream/z5;JJ)V
